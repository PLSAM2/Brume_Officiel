        ...
        Pass 
        {
         ...
         uniform float4 _LightColor0;
            ...
            float4 frag (v2f i) : COLOR {
                return LIGHT_ATTENUATION(i) * _LightColor0;
            }
            ENDCG
        } //Pass
...
// ----------------------------- FINAL PASS ----------------------------- //       
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed4 lighting = tex2Dproj(_GrabTexture, UNITY_PROJ_COORD(i.uvgrab));
                c += ((1.0f-Luminance(lighting))-_BlotchSub)*_BlotchMulti;  
