...
Shader "TerrainMaterialShader"
{
	Properties
	{
		...
		[Toggle(_IB_SHADOW_ON)] _IB_Shadow("IB_Shadow?", Float) = 0
		_IB_StepShadow("IB_StepShadow", Float) = 0
		_IB_StepAttenuation("IB_StepAttenuation", Float) = 0.1
		_IB_ShadowColor("IB_ShadowColor", Color) = (0,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature_local _IB_SHADOW_ON
			...
			float _IB_StepAttenuation;
			float _IB_StepShadow;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float localStochasticTiling171_g101 = ( 0.0 );
				float2 temp_cast_4 = (_T1_PaintGrunge_Tiling).xx;
				float2 texCoord1394 = IN.ase_texcoord4.xy * temp_cast_4 + float2( 0,0 );
				float2 Input_UV145_g101 = texCoord1394;
				float2 UV171_g101 = Input_UV145_g101;
				float2 UV1171_g101 = float2( 0,0 );
				float2 UV2171_g101 = float2( 0,0 );
				float2 UV3171_g101 = float2( 0,0 );
				float W1171_g101 = 0.0;
				float W2171_g101 = 0.0;
				float W3171_g101 = 0.0;
				StochasticTiling( UV171_g101 , UV1171_g101 , UV2171_g101 , UV3171_g101 , W1171_g101 , W2171_g101 , W3171_g101 );
				float Input_Index184_g101 = 3.0;
				float2 temp_output_172_0_g101 = ddx( Input_UV145_g101 );
				float2 temp_output_182_0_g101 = ddy( Input_UV145_g101 );
				float4 Output_2DArray294_g101 = ( ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_1_Grunges, sampler_TA_1_Grunges, UV1171_g101,Input_Index184_g101, temp_output_172_0_g101, temp_output_182_0_g101 ) * W1171_g101 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_1_Grunges, sampler_TA_1_Grunges, UV2171_g101,Input_Index184_g101, temp_output_172_0_g101, temp_output_182_0_g101 ) * W2171_g101 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_1_Grunges, sampler_TA_1_Grunges, UV3171_g101,Input_Index184_g101, temp_output_172_0_g101, temp_output_182_0_g101 ) * W3171_g101 ) );
				float lerpResult1420 = lerp( 1.0 , ( CalculateContrast(_T1_PaintGrunge_Contrast,Output_2DArray294_g101) * _T1_PaintGrunge_Multiply ).r , _T1_PaintGrunge);
				...
				float localStochasticTiling171_g100 = ( 0.0 );
				float2 Input_UV145_g100 = texCoord1385;
				float2 UV171_g100 = Input_UV145_g100;
				float2 UV1171_g100 = float2( 0,0 );
				float2 UV2171_g100 = float2( 0,0 );
				float2 UV3171_g100 = float2( 0,0 );
				float W1171_g100 = 0.0;
				float W2171_g100 = 0.0;
				float W3171_g100 = 0.0;
				StochasticTiling( UV171_g100 , UV1171_g100 , UV2171_g100 , UV3171_g100 , W1171_g100 , W2171_g100 , W3171_g100 );
				float Input_Index184_g100 = 0.0;
				float2 temp_output_172_0_g100 = ddx( Input_UV145_g100 );
				float2 temp_output_182_0_g100 = ddy( Input_UV145_g100 );
				float4 Output_2DArray294_g100 = ( ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_1_Textures, sampler_TA_1_Textures, UV1171_g100,Input_Index184_g100, temp_output_172_0_g100, temp_output_182_0_g100 ) * W1171_g100 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_1_Textures, sampler_TA_1_Textures, UV2171_g100,Input_Index184_g100, temp_output_172_0_g100, temp_output_182_0_g100 ) * W2171_g100 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_1_Textures, sampler_TA_1_Textures, UV3171_g100,Input_Index184_g100, temp_output_172_0_g100, temp_output_182_0_g100 ) * W3171_g100 ) );
				float4 lerpResult1434 = lerp( SAMPLE_TEXTURE2D_ARRAY( _TA_1_Textures, sampler_TA_1_Textures, texCoord1385,0.0 ) , Output_2DArray294_g100 , _T1_Albedo_ProceduralTiling);
				...
				float4 lerpResult340 = lerp( T1_End_OutBrume187 , T1_End_InBrume1477 , Out_or_InBrume606);
				...
				float3 temp_cast_12 = (SAMPLE_TEXTURE2D_ARRAY( _TA_2_Grunges, sampler_TA_2_Grunges, lerpResult891,0.0 ).r).xxx;
				...
				float localStochasticTiling171_g99 = ( 0.0 );
				float2 temp_cast_14 = (_T2_PaintGrunge_Tiling).xx;
				float2 texCoord1393 = IN.ase_texcoord4.xy * temp_cast_14 + float2( 0,0 );
				float2 Input_UV145_g99 = texCoord1393;
				float2 UV171_g99 = Input_UV145_g99;
				float2 UV1171_g99 = float2( 0,0 );
				float2 UV2171_g99 = float2( 0,0 );
				float2 UV3171_g99 = float2( 0,0 );
				float W1171_g99 = 0.0;
				float W2171_g99 = 0.0;
				float W3171_g99 = 0.0;
				StochasticTiling( UV171_g99 , UV1171_g99 , UV2171_g99 , UV3171_g99 , W1171_g99 , W2171_g99 , W3171_g99 );
				float Input_Index184_g99 = 4.0;
				float2 temp_output_172_0_g99 = ddx( Input_UV145_g99 );
				float2 temp_output_182_0_g99 = ddy( Input_UV145_g99 );
				float4 Output_2DArray294_g99 = ( ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_2_Grunges, sampler_TA_2_Grunges, UV1171_g99,Input_Index184_g99, temp_output_172_0_g99, temp_output_182_0_g99 ) * W1171_g99 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_2_Grunges, sampler_TA_2_Grunges, UV2171_g99,Input_Index184_g99, temp_output_172_0_g99, temp_output_182_0_g99 ) * W2171_g99 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_2_Grunges, sampler_TA_2_Grunges, UV3171_g99,Input_Index184_g99, temp_output_172_0_g99, temp_output_182_0_g99 ) * W3171_g99 ) );
				float lerpResult1431 = lerp( 1.0 , ( CalculateContrast(_T2_PaintGrunge_Contrast,Output_2DArray294_g99) * _T2_PaintGrunge_Multiply ).r , _T2_PaintGrunge);
				float T2_Albedo_Tiling1378 = _T2_Albedo_Tiling;
				float2 temp_cast_15 = (T2_Albedo_Tiling1378).xx;
				float2 texCoord1392 = IN.ase_texcoord4.xy * temp_cast_15 + float2( 0,0 );
				float localStochasticTiling171_g104 = ( 0.0 );
				float2 Input_UV145_g104 = texCoord1392;
				...
				float Input_Index184_g104 = 0.0;
				float2 temp_output_172_0_g104 = ddx( Input_UV145_g104 );
				float2 temp_output_182_0_g104 = ddy( Input_UV145_g104 );
				float4 Output_2DArray294_g104 = ( ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_2_Textures, sampler_TA_2_Textures, UV1171_g104,Input_Index184_g104, temp_output_172_0_g104, temp_output_182_0_g104 ) * W1171_g104 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_2_Textures, sampler_TA_2_Textures, UV2171_g104,Input_Index184_g104, temp_output_172_0_g104, temp_output_182_0_g104 ) * W2171_g104 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_2_Textures, sampler_TA_2_Textures, UV3171_g104,Input_Index184_g104, temp_output_172_0_g104, temp_output_182_0_g104 ) * W3171_g104 ) );
				float4 lerpResult1437 = lerp( SAMPLE_TEXTURE2D_ARRAY( _TA_2_Textures, sampler_TA_2_Textures, texCoord1392,0.0 ) , Output_2DArray294_g104 , _T2_Albedo_ProceduralTiling);
				...
				float4 temp_cast_17 = (grayscale905).xxxx;
				float4 lerpResult886 = lerp( CalculateContrast(_T2_Albedo_Contrast,temp_output_903_0) , temp_cast_17 , GrayscaleDebug614);
				...
				float4 lerpResult871 = lerp( T2_End_OutBrume839 , T2_End_InBrume1480 , Out_or_InBrume606);
				...
				float3 temp_cast_21 = (SAMPLE_TEXTURE2D_ARRAY( _TA_3_Grunges, sampler_TA_3_Grunges, lerpResult1081,0.0 ).r).xxx;
				...
				float localStochasticTiling171_g105 = ( 0.0 );
				float2 temp_cast_23 = (_T3_PaintGrunge_Tiling).xx;
				float2 texCoord1391 = IN.ase_texcoord4.xy * temp_cast_23 + float2( 0,0 );
				float2 Input_UV145_g105 = texCoord1391;
				float2 UV171_g105 = Input_UV145_g105;
				float2 UV1171_g105 = float2( 0,0 );
				float2 UV2171_g105 = float2( 0,0 );
				float2 UV3171_g105 = float2( 0,0 );
				float W1171_g105 = 0.0;
				float W2171_g105 = 0.0;
				float W3171_g105 = 0.0;
				StochasticTiling( UV171_g105 , UV1171_g105 , UV2171_g105 , UV3171_g105 , W1171_g105 , W2171_g105 , W3171_g105 );
				float Input_Index184_g105 = 4.0;
				float2 temp_output_172_0_g105 = ddx( Input_UV145_g105 );
				float2 temp_output_182_0_g105 = ddy( Input_UV145_g105 );
				float4 Output_2DArray294_g105 = ( ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_3_Grunges, sampler_TA_3_Grunges, UV1171_g105,Input_Index184_g105, temp_output_172_0_g105, temp_output_182_0_g105 ) * W1171_g105 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_3_Grunges, sampler_TA_3_Grunges, UV2171_g105,Input_Index184_g105, temp_output_172_0_g105, temp_output_182_0_g105 ) * W2171_g105 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_3_Grunges, sampler_TA_3_Grunges, UV3171_g105,Input_Index184_g105, temp_output_172_0_g105, temp_output_182_0_g105 ) * W3171_g105 ) );
				float lerpResult1450 = lerp( 1.0 , ( CalculateContrast(_T3_PaintGrunge_Contrast,Output_2DArray294_g105) * _T3_PaintGrunge_Multiply ).r , _T3_PaintGrunge);
				float T3_Albedo_Tiling1377 = _T3_Albedo_Tiling;
				float2 temp_cast_24 = (T3_Albedo_Tiling1377).xx;
				float2 texCoord1390 = IN.ase_texcoord4.xy * temp_cast_24 + float2( 0,0 );
				float localStochasticTiling171_g106 = ( 0.0 );
				float2 Input_UV145_g106 = texCoord1390;
				...
				float4 Output_2DArray294_g106 = ( ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_3_Textures, sampler_TA_3_Textures, UV1171_g106,Input_Index184_g106, temp_output_172_0_g106, temp_output_182_0_g106 ) * W1171_g106 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_3_Textures, sampler_TA_3_Textures, UV2171_g106,Input_Index184_g106, temp_output_172_0_g106, temp_output_182_0_g106 ) * W2171_g106 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_3_Textures, sampler_TA_3_Textures, UV3171_g106,Input_Index184_g106, temp_output_172_0_g106, temp_output_182_0_g106 ) * W3171_g106 ) );
				float4 lerpResult1441 = lerp( SAMPLE_TEXTURE2D_ARRAY( _TA_3_Textures, sampler_TA_3_Textures, texCoord1390,0.0 ) , Output_2DArray294_g106 , _T3_Albedo_ProceduralTiling);
				...
				float4 temp_cast_26 = (grayscale1113).xxxx;
				float4 lerpResult1085 = lerp( temp_output_1094_0 , temp_cast_26 , GrayscaleDebug614);
				...
				float4 lerpResult1196 = lerp( T3_End_OutBrume1119 , T3_End_InBrume1482 , Out_or_InBrume606);
				...
				float3 temp_cast_30 = (SAMPLE_TEXTURE2D_ARRAY( _TA_4_Grunges, sampler_TA_4_Grunges, lerpResult1069,0.0 ).r).xxx;
				...
				float localStochasticTiling171_g102 = ( 0.0 );
				float2 temp_cast_32 = (_T4_PaintGrunge_Tiling).xx;
				float2 texCoord1388 = IN.ase_texcoord4.xy * temp_cast_32 + float2( 0,0 );
				float2 Input_UV145_g102 = texCoord1388;
				float2 UV171_g102 = Input_UV145_g102;
				float2 UV1171_g102 = float2( 0,0 );
				float2 UV2171_g102 = float2( 0,0 );
				float2 UV3171_g102 = float2( 0,0 );
				float W1171_g102 = 0.0;
				float W2171_g102 = 0.0;
				float W3171_g102 = 0.0;
				StochasticTiling( UV171_g102 , UV1171_g102 , UV2171_g102 , UV3171_g102 , W1171_g102 , W2171_g102 , W3171_g102 );
				float Input_Index184_g102 = 4.0;
				float2 temp_output_172_0_g102 = ddx( Input_UV145_g102 );
				float2 temp_output_182_0_g102 = ddy( Input_UV145_g102 );
				float4 Output_2DArray294_g102 = ( ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_4_Grunges, sampler_TA_4_Grunges, UV1171_g102,Input_Index184_g102, temp_output_172_0_g102, temp_output_182_0_g102 ) * W1171_g102 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_4_Grunges, sampler_TA_4_Grunges, UV2171_g102,Input_Index184_g102, temp_output_172_0_g102, temp_output_182_0_g102 ) * W2171_g102 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_4_Grunges, sampler_TA_4_Grunges, UV3171_g102,Input_Index184_g102, temp_output_172_0_g102, temp_output_182_0_g102 ) * W3171_g102 ) );
				float lerpResult1455 = lerp( 1.0 , ( CalculateContrast(_T4_PaintGrunge_Contrast,Output_2DArray294_g102) * _T4_PaintGrunge_Multiply ).r , _T4_PaintGrunge);
				float T4_Albedo_Tiling1376 = _T4_Albedo_Tiling;
				float2 temp_cast_33 = (T4_Albedo_Tiling1376).xx;
				float2 texCoord1389 = IN.ase_texcoord4.xy * temp_cast_33 + float2( 0,0 );
				float localStochasticTiling171_g103 = ( 0.0 );
				float2 Input_UV145_g103 = texCoord1389;
				...
				float Input_Index184_g103 = 0.0;
				float2 temp_output_172_0_g103 = ddx( Input_UV145_g103 );
				float2 temp_output_182_0_g103 = ddy( Input_UV145_g103 );
				float4 Output_2DArray294_g103 = ( ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_4_Textures, sampler_TA_4_Textures, UV1171_g103,Input_Index184_g103, temp_output_172_0_g103, temp_output_182_0_g103 ) * W1171_g103 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_4_Textures, sampler_TA_4_Textures, UV2171_g103,Input_Index184_g103, temp_output_172_0_g103, temp_output_182_0_g103 ) * W2171_g103 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_4_Textures, sampler_TA_4_Textures, UV3171_g103,Input_Index184_g103, temp_output_172_0_g103, temp_output_182_0_g103 ) * W3171_g103 ) );
				float4 lerpResult1444 = lerp( SAMPLE_TEXTURE2D_ARRAY( _TA_4_Textures, sampler_TA_4_Textures, texCoord1389,0.0 ) , Output_2DArray294_g103 , _T4_Albedo_ProceduralTiling);
				...
				float4 temp_cast_35 = (grayscale1051).xxxx;
				float4 lerpResult1074 = lerp( temp_output_1079_0 , temp_cast_35 , GrayscaleDebug614);
				...
				float4 lerpResult1050 = lerp( T4_End_OutBrume1120 , T4_End_InBrume1485 , Out_or_InBrume606);
				...
				float2 temp_cast_37 = (T1_Albedo_Tiling1379).xx;
				float2 texCoord1386 = IN.ase_texcoord4.xy * temp_cast_37 + float2( 0,0 );
				...
				float2 temp_cast_38 = (T2_Albedo_Tiling1378).xx;
				float2 texCoord1398 = IN.ase_texcoord4.xy * temp_cast_38 + float2( 0,0 );
				float2 Input_UV145_g97 = texCoord1398;
				...
				float4 Output_2DArray294_g97 = ( ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_2_Textures, sampler_TA_2_Textures, UV1171_g97,Input_Index184_g97, temp_output_172_0_g97, temp_output_182_0_g97 ) * W1171_g97 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_2_Textures, sampler_TA_2_Textures, UV2171_g97,Input_Index184_g97, temp_output_172_0_g97, temp_output_182_0_g97 ) * W2171_g97 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_2_Textures, sampler_TA_2_Textures, UV3171_g97,Input_Index184_g97, temp_output_172_0_g97, temp_output_182_0_g97 ) * W3171_g97 ) );
				float4 T2_Normal_Texture1396 = Output_2DArray294_g97;
				...
				float2 temp_cast_39 = (T3_Albedo_Tiling1377).xx;
				float2 texCoord1404 = IN.ase_texcoord4.xy * temp_cast_39 + float2( 0,0 );
				...
				float localStochasticTiling171_g98 = ( 0.0 );
				float2 temp_cast_40 = (T3_Albedo_Tiling1377).xx;
				float2 texCoord1410 = IN.ase_texcoord4.xy * temp_cast_40 + float2( 0,0 );
				float2 Input_UV145_g98 = texCoord1410;
				float2 UV171_g98 = Input_UV145_g98;
				float2 UV1171_g98 = float2( 0,0 );
				float2 UV2171_g98 = float2( 0,0 );
				float2 UV3171_g98 = float2( 0,0 );
				float W1171_g98 = 0.0;
				float W2171_g98 = 0.0;
				float W3171_g98 = 0.0;
				StochasticTiling( UV171_g98 , UV1171_g98 , UV2171_g98 , UV3171_g98 , W1171_g98 , W2171_g98 , W3171_g98 );
				float Input_Index184_g98 = 1.0;
				float2 temp_output_172_0_g98 = ddx( Input_UV145_g98 );
				float2 temp_output_182_0_g98 = ddy( Input_UV145_g98 );
				float4 Output_2DArray294_g98 = ( ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_4_Textures, sampler_TA_4_Textures, UV1171_g98,Input_Index184_g98, temp_output_172_0_g98, temp_output_182_0_g98 ) * W1171_g98 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_4_Textures, sampler_TA_4_Textures, UV2171_g98,Input_Index184_g98, temp_output_172_0_g98, temp_output_182_0_g98 ) * W2171_g98 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TA_4_Textures, sampler_TA_4_Textures, UV3171_g98,Input_Index184_g98, temp_output_172_0_g98, temp_output_182_0_g98 ) * W3171_g98 ) );
				float4 T4_Normal_Texture1408 = Output_2DArray294_g98;
				...
				float2 temp_cast_42 = (_Noise_Tiling).xx;
				float2 texCoord170 = IN.ase_texcoord4.xy * temp_cast_42 + float2( 0,0 );
				...
				float4 temp_cast_43 = (( saturate( ( 1.0 - ( ( 1.0 - blendOpDest429) / max( blendOpSrc429, 0.00001) ) ) ))).xxxx;
				float4 blendOpSrc434 = temp_cast_43;
				...
				float smoothstepResult1498 = smoothstep( _IB_StepShadow , ( _IB_StepShadow + _IB_StepAttenuation ) , normal_LightDir140);
				#ifdef _IB_SHADOW_ON
				float4 staticSwitch1510 = ( smoothstepResult1498 + ( ( 1.0 - smoothstepResult1498 ) * _IB_ShadowColor ) );
				#else
				float4 staticSwitch1510 = temp_cast_44;
				#endif
				float4 IB_Shadows1496 = staticSwitch1510;
				float4 lerpResult1010 = lerp( Shadows428 , IB_Shadows1496 , Out_or_InBrume606);
				float4 temp_cast_45 = (normal_LightDir140).xxxx;
				float LightDebug608 = _LightDebug;
				float4 lerpResult282 = lerp( ( AllAlbedo622 * lerpResult1010 ) , temp_cast_45 , LightDebug608);
...
/*ASEBEGIN
Version=18707
1920;0;1920;1019;-626.8966;7293.484;1;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;28;-3050.692,-3874.95;Inherit;False;1708.676;476.5241;Final Mix;13;698;2;705;704;286;282;294;609;611;280;1010;1012;1497;;0,0,0,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1191;-13683.7,-956.8566;Inherit;False;Property;_T3_AnimatedGrunge_Flipbook_Rows;T3_AnimatedGrunge_Flipbook_Rows;79;0;Create;True;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1134;-12499.16,2945.502;Inherit;False;Property;_T4_ColorCorrection;T4_ColorCorrection;89;0;Create;True;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;1125;-13377.28,2790.281;Inherit;True;Procedural Sample;-1;;103;f5379ff72769e2b4495e5ce2f004d8d4;2,157,1,315,1;7;82;SAMPLER2D;0;False;158;SAMPLER2DARRAY;0;False;183;FLOAT;0;False;5;FLOAT2;0,0;False;80;FLOAT3;0,0,0;False;104;FLOAT2;1,1;False;74;SAMPLERSTATE;0;False;5;COLOR;0;FLOAT;32;FLOAT;33;FLOAT;34;FLOAT;35
Node;AmplifyShaderEditor.RangedFloatNode;258;-13967.71,-5731.008;Inherit;False;Property;_T1_PaintGrunge_Tiling;T1_PaintGrunge_Tiling;26;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;409;-13725.7,-4537.365;Inherit;False;Property;_T1_CustomRimLight;T1_CustomRimLight?;38;0;Create;True;0;0;False;1;Header(T1 Custom Rim Light);False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1149;-13350.02,-425.4093;Inherit;False;Property;_T3_PaintGrunge_Contrast;T3_PaintGrunge_Contrast;72;0;Create;True;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;1145;-15378.94,1564.851;Inherit;True;Property;_TA_4_Textures;TA_4_Textures;87;0;Create;True;0;0;False;1;Header(Texture 4 VertexPaintBlue);False;ef1e633c4c2c51641bd59a932b55b28a;None;False;white;Auto;Texture2DArray;-1;0;2;SAMPLER2DARRAY;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;1135;-12801.78,2436.467;Inherit;False;Property;_T4_PaintGrunge_Multiply;T4_PaintGrunge_Multiply;95;0;Create;True;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1166;-13965.83,2613.188;Inherit;False;Property;_T4_PaintGrunge_Tiling;T4_PaintGrunge_Tiling;93;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;866;-15380.65,-4003.868;Inherit;True;Property;_TA_2_Textures;TA_2_Textures;42;0;Create;True;0;0;False;1;Header(Texture 2 VertexPaintRed);False;ef1e633c4c2c51641bd59a932b55b28a;2b6e729c66a58e64e9da60628e5652f1;False;white;Auto;Texture2DArray;-1;0;2;SAMPLER2DARRAY;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;717;-12455.45,-6645.18;Inherit;False;Property;_T1_AnimatedGrunge_Contrast;T1_AnimatedGrunge_Contrast;36;0;Create;True;0;0;False;0;False;1.58;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;377;-13351.73,-5994.128;Inherit;False;Property;_T1_PaintGrunge_Contrast;T1_PaintGrunge_Contrast;27;0;Create;True;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1155;-12468.57,1709.016;Inherit;False;Property;_T4_AnimatedGrunge_Contrast;T4_AnimatedGrunge_Contrast;103;0;Create;True;0;0;False;0;False;1.58;0.46;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;737;-15405.28,-6061.924;Inherit;True;Property;_TA_1_Grunges;TA_1_Grunges;21;0;Create;True;0;0;False;0;False;ef1e633c4c2c51641bd59a932b55b28a;None;False;white;Auto;Texture2DArray;-1;0;2;SAMPLER2DARRAY;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;1170;-12801.95,-339.0104;Inherit;False;Property;_T3_PaintGrunge_Multiply;T3_PaintGrunge_Multiply;73;0;Create;True;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1159;-13684.53,1744.621;Inherit;False;Property;_T4_AnimatedGrunge_Flipbook_Columns;T4_AnimatedGrunge_Flipbook_Columns;100;0;Create;True;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;318;-12154.52,-6639.99;Inherit;False;Property;_T1_AnimatedGrunge_Multiply;T1_AnimatedGrunge_Multiply;37;0;Create;True;0;0;False;0;False;1.58;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;617;-13379.16,-5553.915;Inherit;True;Procedural Sample;-1;;100;f5379ff72769e2b4495e5ce2f004d8d4;2,157,1,315,1;7;82;SAMPLER2D;0;False;158;SAMPLER2DARRAY;0;False;183;FLOAT;0;False;5;FLOAT2;0,0;False;80;FLOAT3;0,0,0;False;104;FLOAT2;1,1;False;74;SAMPLERSTATE;0;False;5;COLOR;0;FLOAT;32;FLOAT;33;FLOAT;34;FLOAT;35
Node;AmplifyShaderEditor.RangedFloatNode;1160;-13684.7,-1030.857;Inherit;False;Property;_T3_AnimatedGrunge_Flipbook_Columns;T3_AnimatedGrunge_Flipbook_Columns;78;0;Create;True;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1062;-13695.29,2181.06;Inherit;True;Procedural Sample;-1;;102;f5379ff72769e2b4495e5ce2f004d8d4;2,157,1,315,1;7;82;SAMPLER2D;0;False;158;SAMPLER2DARRAY;0;False;183;FLOAT;0;False;5;FLOAT2;0,0;False;80;FLOAT3;0,0,0;False;104;FLOAT2;1,0;False;74;SAMPLERSTATE;0;False;5;COLOR;0;FLOAT;32;FLOAT;33;FLOAT;34;FLOAT;35
Node;AmplifyShaderEditor.RangedFloatNode;1167;-11185.25,-756.4875;Inherit;False;Property;_T3_CutomRimLight_Texture;T3_CutomRimLight_Texture?;84;0;Create;True;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1432;-11976.39,-3110.053;Inherit;False;Property;_T2_PaintGrunge;T2_PaintGrunge?;48;0;Create;True;0;0;False;1;Header(T2 Paint Grunge);False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;297;-12803.66,-5907.729;Inherit;False;Property;_T1_PaintGrunge_Multiply;T1_PaintGrunge_Multiply;28;0;Create;True;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1158;-13683.53,1818.621;Inherit;False;Property;_T4_AnimatedGrunge_Flipbook_Rows;T4_AnimatedGrunge_Flipbook_Rows;101;0;Create;True;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;818;-13351.56,-3218.651;Inherit;False;Property;_T2_PaintGrunge_Contrast;T2_PaintGrunge_Contrast;50;0;Create;True;0;0;False;0;False;0;-3.64;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1072;-14003.31,3016.647;Inherit;False;Property;_T4_Albedo_Tiling;T4_Albedo_Tiling;91;0;Create;True;0;0;False;0;False;1;2.06;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;910;-12160.35,-3886.513;Inherit;False;Property;_T2_AnimatedGrunge_Multiply;T2_AnimatedGrunge_Multiply;60;0;Create;True;0;0;False;0;False;1.58;1.61;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;1098;-15356.4,2281.271;Inherit;True;Property;_TA_4_Grunges;TA_4_Grunges;88;0;Create;True;0;0;False;0;False;ef1e633c4c2c51641bd59a932b55b28a;None;False;white;Auto;Texture2DArray;-1;0;2;SAMPLER2DARRAY;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;820;-14014.19,-3908.85;Inherit;False;Property;_T2_AnimatedGrunge_Tiling;T2_AnimatedGrunge_Tiling;55;0;Create;True;0;0;False;0;False;1;32;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;906;-13378.99,-2778.438;Inherit;True;Procedural Sample;-1;;104;f5379ff72769e2b4495e5ce2f004d8d4;2,157,1,315,1;7;82;SAMPLER2D;0;False;158;SAMPLER2DARRAY;0;False;183;FLOAT;0;False;5;FLOAT2;0,0;False;80;FLOAT3;0,0,0;False;104;FLOAT2;1,1;False;74;SAMPLERSTATE;0;False;5;COLOR;0;FLOAT;32;FLOAT;33;FLOAT;34;FLOAT;35
...
Node;AmplifyShaderEditor.FunctionNode;1105;-13695.46,-594.4177;Inherit;True;Procedural Sample;-1;;105;f5379ff72769e2b4495e5ce2f004d8d4;2,157,1,315,1;7;82;SAMPLER2D;0;False;158;SAMPLER2DARRAY;0;False;183;FLOAT;0;False;5;FLOAT2;0,0;False;80;FLOAT3;0,0,0;False;104;FLOAT2;1,0;False;74;SAMPLERSTATE;0;False;5;COLOR;0;FLOAT;32;FLOAT;33;FLOAT;34;FLOAT;35
...
Node;AmplifyShaderEditor.RangedFloatNode;1456;-12008.05,2446.345;Inherit;False;Property;_T4_PaintGrunge;T4_PaintGrunge?;92;0;Create;True;0;0;False;1;Header(T4 Paint Grunge);False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1124;-13377.45,14.80359;Inherit;True;Procedural Sample;-1;;106;f5379ff72769e2b4495e5ce2f004d8d4;2,157,1,315,1;7;82;SAMPLER2D;0;False;158;SAMPLER2DARRAY;0;False;183;FLOAT;0;False;5;FLOAT2;0,0;False;80;FLOAT3;0,0,0;False;104;FLOAT2;1,1;False;74;SAMPLERSTATE;0;False;5;COLOR;0;FLOAT;32;FLOAT;33;FLOAT;34;FLOAT;35
...
Node;AmplifyShaderEditor.RangedFloatNode;1419;-12024.48,-5929.408;Inherit;False;Property;_T1_PaintGrunge;T1_PaintGrunge?;25;0;Create;True;0;0;False;1;Header(T1 Paint Grunge);False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1443;-13089.75,2909.883;Inherit;False;Property;_T4_Albedo_ProceduralTiling;T4_Albedo_ProceduralTiling?;90;0;Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1126;-12499.33,170.0253;Inherit;False;Property;_T3_ColorCorrection;T3_ColorCorrection;67;0;Create;True;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1435;-13077.44,-5455.58;Inherit;False;Property;_T1_Albedo_ProceduralTiling;T1_Albedo_ProceduralTiling?;23;0;Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;1498;703.2891,-6913.666;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;1508;1317.441,-6914.171;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;1496;1849.954,-6918.681;Inherit;False;IB_Shadows;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;813;-11186.79,-3549.729;Inherit;False;Property;_T2_CutomRimLight_Texture;T2_CutomRimLight_Texture?;62;0;Create;True;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1493;458.5259,-6917.916;Inherit;False;140;normal_LightDir;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1089;-13682.7,-881.8566;Inherit;False;Property;_T3_AnimatedGrunge_Flipbook_Speed;T3_AnimatedGrunge_Flipbook_Speed;80;0;Create;True;0;0;False;0;False;1;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;706;-15407.82,-6778.345;Inherit;True;Property;_TA_1_Textures;TA_1_Textures;20;0;Create;True;0;0;False;1;Header(Texture 1 VertexPaintBlack);False;ef1e633c4c2c51641bd59a932b55b28a;None;False;white;Auto;Texture2DArray;-1;0;2;SAMPLER2DARRAY;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;1429;-11941.01,-3615.568;Inherit;False;Property;_T2_AnimatedGrunge;T2_AnimatedGrunge?;52;0;Create;True;0;0;False;1;Header(T2 Animated Grunge);False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1157;-13682.53,1893.621;Inherit;False;Property;_T4_AnimatedGrunge_Flipbook_Speed;T4_AnimatedGrunge_Flipbook_Speed;102;0;Create;True;0;0;False;0;False;1;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;888;-14023.02,-2549.071;Inherit;False;Property;_T2_Albedo_Tiling;T2_Albedo_Tiling;47;0;Create;True;0;0;False;0;False;1;15;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;916;-13697,-3387.659;Inherit;True;Procedural Sample;-1;;99;f5379ff72769e2b4495e5ce2f004d8d4;2,157,1,315,1;7;82;SAMPLER2D;0;False;158;SAMPLER2DARRAY;0;False;183;FLOAT;0;False;5;FLOAT2;0,0;False;80;FLOAT3;0,0,0;False;104;FLOAT2;1,0;False;74;SAMPLERSTATE;0;False;5;COLOR;0;FLOAT;32;FLOAT;33;FLOAT;34;FLOAT;35
Node;AmplifyShaderEditor.RangedFloatNode;1440;-13078.34,125.3606;Inherit;False;Property;_T3_Albedo_ProceduralTiling;T3_Albedo_ProceduralTiling?;68;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;915;-14018.54,-2963.531;Inherit;False;Property;_T2_PaintGrunge_Tiling;T2_PaintGrunge_Tiling;49;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1092;-14028.48,242.1707;Inherit;False;Property;_T3_Albedo_Tiling;T3_Albedo_Tiling;69;0;Create;True;0;0;False;0;False;1;15;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;397;-11164.96,-6581.207;Inherit;False;Property;_T1_CustomRimLight_Color;T1_CustomRimLight_Color;40;0;Create;True;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1458;-12392.42,-2509.62;Inherit;False;Property;_T2_Albedo_Contrast;T2_Albedo_Contrast;45;0;Create;True;0;0;False;0;False;0;1.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;1501;545.2891,-6780.666;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1048;-13716.29,3808.578;Inherit;False;Property;_T4_CustomRimLight;T4_CustomRimLight?;105;0;Create;True;0;0;False;1;Header(T4 Custom Rim Light);False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1503;875.4993,-6639.667;Inherit;False;Property;_IB_ShadowColor;IB_ShadowColor;17;0;Create;True;0;0;False;0;False;0,0,0,0;0.3301886,0.3301886,0.3301886,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1171;-13349.85,2350.068;Inherit;False;Property;_T4_PaintGrunge_Contrast;T4_PaintGrunge_Contrast;94;0;Create;True;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1169;-13966,-162.2892;Inherit;False;Property;_T3_PaintGrunge_Tiling;T3_PaintGrunge_Tiling;71;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;128;-3926.91,-5717.327;Inherit;False;Property;_Noise_Tiling;Noise_Tiling;18;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;602;-11186.96,-6325.206;Inherit;False;Property;_T1_CustomRimLight_Texture;T1_CustomRimLight_Texture?;39;0;Create;True;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1151;-11131.22,1641.605;Inherit;False;Property;_T4_CustomRimLight_Opacity;T4_CustomRimLight_Opacity;108;0;Create;True;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;874;-15358.11,-3287.447;Inherit;True;Property;_TA_2_Grunges;TA_2_Grunges;43;0;Create;True;0;0;False;0;False;ef1e633c4c2c51641bd59a932b55b28a;8f4c22a1083f0e64f8a4c34b3cc88618;False;white;Auto;Texture2DArray;-1;0;2;SAMPLER2DARRAY;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;621;-14039.19,-5328.548;Inherit;False;Property;_T1_Albedo_Tiling;T1_Albedo_Tiling;24;0;Create;True;0;0;False;0;False;1;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1422;-11942.54,-6413.93;Inherit;False;Property;_T1_AnimatedGrunge;T1_AnimatedGrunge?;29;0;Create;True;0;0;False;1;Header(T1 Animated Grunge);False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;385;-11133.1,-6702.591;Inherit;False;Property;_T1_CustomRimLight_Opacity;T1_CustomRimLight_Opacity;41;0;Create;True;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.LightAttenuation;358;-3945.75,-6366.965;Inherit;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1397;181.5387,-5477.017;Inherit;True;Procedural Sample;-1;;97;f5379ff72769e2b4495e5ce2f004d8d4;2,157,1,315,1;7;82;SAMPLER2D;0;False;158;SAMPLER2DARRAY;0;False;183;FLOAT;0;False;5;FLOAT2;0,0;False;80;FLOAT3;0,0,0;False;104;FLOAT2;1,1;False;74;SAMPLERSTATE;0;False;5;COLOR;0;FLOAT;32;FLOAT;33;FLOAT;34;FLOAT;35
...
Node;AmplifyShaderEditor.RangedFloatNode;1165;-11185.08,2018.99;Inherit;False;Property;_T4_CutomRimLight_Texture;T4_CutomRimLight_Texture?;106;0;Create;True;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1438;-13076.64,-2658.16;Inherit;False;Property;_T2_Albedo_ProceduralTiling;T2_Albedo_ProceduralTiling?;46;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;1193;-15356.57,-494.2053;Inherit;True;Property;_TA_3_Grunges;TA_3_Grunges;66;0;Create;True;0;0;False;0;False;ef1e633c4c2c51641bd59a932b55b28a;b33b36e28008b23459206c358b00d02a;False;white;Auto;Texture2DArray;-1;0;2;SAMPLER2DARRAY;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SamplerNode;741;-4512.905,-5586.063;Inherit;True;Property;_InBrumeDrippingNoise;InBrumeDrippingNoise;19;0;Create;True;0;0;False;0;False;-1;4d5dbc1ba3dda0143a39c6a1fa10a3b9;0fe9101c6b6e1124b90b120ceebd6cba;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1153;-11131.39,-1133.872;Inherit;False;Property;_T3_CustomRimLight_Opacity;T3_CustomRimLight_Opacity;86;0;Create;True;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;822;-13940.24,-3746.098;Inherit;False;Property;_T2_AnimatedGrunge_Flipbook_Columns;T2_AnimatedGrunge_Flipbook_Columns;56;0;Create;True;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;1363;-15377.53,-1210.626;Inherit;True;Property;_TA_3_Textures;TA_3_Textures;65;0;Create;True;0;0;False;1;Header(Texture 3 VertexPaintGreen);False;ef1e633c4c2c51641bd59a932b55b28a;0556bc6f8449b5645a36bdb589f4767d;False;white;Auto;Texture2DArray;-1;0;2;SAMPLER2DARRAY;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;1464;-14018.6,-6591.532;Inherit;False;Property;_T1_AnimatedGrunge_ScreenBased;T1_AnimatedGrunge_ScreenBased?;31;0;Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCGrayscale;403;-12370.8,-6889.003;Inherit;True;0;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;841;-13324.09,-4012.472;Inherit;False;Property;_T2_IsGrungeAnimated;T2_IsGrungeAnimated?;53;0;Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;150;-13324.26,-6787.949;Inherit;False;Property;_T1_IsGrungeAnimated;T1_IsGrungeAnimated?;30;0;Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1449;-11998.13,-322.4233;Inherit;False;Property;_T3_PaintGrunge;T3_PaintGrunge?;70;0;Create;True;0;0;False;1;Header(T3 Paint Grunge);False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1200;-13716.46,1024.775;Inherit;False;Property;_T3_CustomRimLight;T3_CustomRimLight?;83;0;Create;True;0;0;False;1;Header(T3 Custom Rim Light);False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;146;-13684.41,-6450.575;Inherit;False;Property;_T1_AnimatedGrunge_Flipbook_Speed;T1_AnimatedGrunge_Flipbook_Speed;35;0;Create;True;0;0;False;0;False;1;6;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1445;-11962.75,-827.9385;Inherit;False;Property;_T3_AnimatedGrunge;T3_AnimatedGrunge?;74;0;Create;True;0;0;False;1;Header(T3 Animated Grunge);False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1168;-11163.08,1762.989;Inherit;False;Property;_T4_CustomRimLight_Color;T4_CustomRimLight_Color;107;0;Create;True;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1154;-12158.81,-1060.272;Inherit;False;Property;_T3_AnimatedGrunge_Multiply;T3_AnimatedGrunge_Multiply;82;0;Create;True;0;0;False;0;False;1.58;1.61;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1409;181.8724,-4786.893;Inherit;True;Procedural Sample;-1;;98;f5379ff72769e2b4495e5ce2f004d8d4;2,157,1,315,1;7;82;SAMPLER2D;0;False;158;SAMPLER2DARRAY;0;False;183;FLOAT;0;False;5;FLOAT2;0,0;False;80;FLOAT3;0,0,0;False;104;FLOAT2;1,1;False;74;SAMPLERSTATE;0;False;5;COLOR;0;FLOAT;32;FLOAT;33;FLOAT;34;FLOAT;35
...
Node;AmplifyShaderEditor.RangedFloatNode;817;-12803.49,-3132.252;Inherit;False;Property;_T2_PaintGrunge_Multiply;T2_PaintGrunge_Multiply;51;0;Create;True;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1472;-3197.546,-4321.959;Inherit;True;Property;_TerrainMaskTexture;TerrainMaskTexture;1;0;Create;True;0;0;False;1;Header(TerrainMask);False;-1;None;1d0288b139a574146a793728c90b64f5;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1162;-12186.64,1711.206;Inherit;False;Property;_T4_AnimatedGrunge_Multiply;T4_AnimatedGrunge_Multiply;104;0;Create;True;0;0;False;0;False;1.58;1.61;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1499;327.2891,-6824.666;Inherit;False;Property;_IB_StepShadow;IB_StepShadow;15;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;819;-12474.28,-3893.703;Inherit;False;Property;_T2_AnimatedGrunge_Contrast;T2_AnimatedGrunge_Contrast;59;0;Create;True;0;0;False;0;False;1.58;0.46;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;1510;1565.897,-6941.484;Inherit;False;Property;_IB_Shadow;IB_Shadow?;14;0;Create;True;0;0;False;0;False;0;0;1;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1161;-13322.55,-1219.23;Inherit;False;Property;_T3_IsGrungeAnimated;T3_IsGrungeAnimated?;75;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1452;-11972.67,1940.83;Inherit;False;Property;_T4_AnimatedGrunge;T4_AnimatedGrunge?;96;0;Create;True;0;0;False;1;Header(T4 Animated Grunge);False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;127;-13685.41,-6525.575;Inherit;False;Property;_T1_AnimatedGrunge_Flipbook_Rows;T1_AnimatedGrunge_Flipbook_Rows;34;0;Create;True;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;132;-13686.41,-6599.575;Inherit;False;Property;_T1_AnimatedGrunge_Flipbook_Columns;T1_AnimatedGrunge_Flipbook_Columns;33;0;Create;True;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1467;-14039.83,-1024.348;Inherit;False;Property;_T3_AnimatedGrunge_ScreenBased;T3_AnimatedGrunge_ScreenBased?;76;0;Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1150;-13322.38,1560.615;Inherit;False;Property;_T4_IsGrungeAnimated;T4_IsGrungeAnimated?;97;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1067;-14020.48,1657.869;Inherit;False;Property;_T4_AnimatedGrunge_Tiling;T4_AnimatedGrunge_Tiling;99;0;Create;True;0;0;False;0;False;1;20;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1156;-12457.74,-1064.461;Inherit;False;Property;_T3_AnimatedGrunge_Contrast;T3_AnimatedGrunge_Contrast;81;0;Create;True;0;0;False;0;False;1.58;0.46;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;399;-12565.26,-5411.059;Inherit;False;Property;_T1_ColorCorrection;T1_ColorCorrection;22;0;Create;True;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;882;-13938.24,-3597.098;Inherit;False;Property;_T2_AnimatedGrunge_Flipbook_Speed;T2_AnimatedGrunge_Flipbook_Speed;58;0;Create;True;0;0;False;0;False;1;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;605;-1275.699,-5824.597;Inherit;False;Property;_Out_or_InBrume;Out_or_InBrume?;0;0;Create;True;0;0;False;1;Header(OutInBrume);False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;923;-12753.84,-2623.216;Inherit;False;Property;_T2_ColorCorrection;T2_ColorCorrection;44;0;Create;True;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;854;-13939.24,-3672.098;Inherit;False;Property;_T2_AnimatedGrunge_Flipbook_Rows;T2_AnimatedGrunge_Flipbook_Rows;57;0;Create;True;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;175;-14019.36,-6680.327;Inherit;False;Property;_T1_AnimatedGrunge_Tiling;T1_AnimatedGrunge_Tiling;32;0;Create;True;0;0;False;0;False;1;32;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1462;-13764.91,-3852.185;Inherit;False;Property;_T2_AnimatedGrunge_ScreenBased;T2_AnimatedGrunge_ScreenBased?;54;0;Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1208;-11163.25,-1012.488;Inherit;False;Property;_T3_CustomRimLight_Color;T3_CustomRimLight_Color;85;0;Create;True;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;807;-13734.25,-1756.652;Inherit;False;Property;_T2_CustomRimLight;T2_CustomRimLight?;61;0;Create;True;0;0;False;1;Header(T2 Custom Rim Light);False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1469;-14031.5,1768.138;Inherit;False;Property;_T4_AnimatedGrunge_ScreenBased;T4_AnimatedGrunge_ScreenBased?;98;0;Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1500;302.2891,-6740.666;Inherit;False;Property;_IB_StepAttenuation;IB_StepAttenuation;16;0;Create;True;0;0;False;0;False;0.1;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1152;-14016.65,-1121.608;Inherit;False;Property;_T3_AnimatedGrunge_Tiling;T3_AnimatedGrunge_Tiling;77;0;Create;True;0;0;False;0;False;1;15;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1502;1087.499,-6793.667;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1511;1377.897,-7001.484;Inherit;False;Constant;_Float6;Float 6;109;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCGrayscale;1476;-9440.299,-6807.266;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;1509;902.4408,-6793.171;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=44F16A0902D4E4321F10CC10218B2ABFBA7A8A0F