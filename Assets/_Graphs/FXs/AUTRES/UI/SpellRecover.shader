	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float2 uv_SpellRecoverSparks = IN.ase_texcoord3.xy * _SpellRecoverSparks_ST.xy + _SpellRecoverSparks_ST.zw;
				...
				float3 Color = ( _Color0 * temp_output_30_0 ).rgb;
				float Alpha = ( temp_output_30_0 * _Float1 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_SpellRecoverSparks = IN.ase_texcoord2.xy * _SpellRecoverSparks_ST.xy + _SpellRecoverSparks_ST.zw;
				float smoothstepResult25 = smoothstep( _Disparition , ( _Disparition + _Float5 ) , tex2D( _SpellRecoverSparks, uv_SpellRecoverSparks ).r);
				float2 temp_cast_0 = (_Float2).xx;
...
/*ASEBEGIN
Version=18707
327;73;1090;622;2203.503;1138.715;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;19;-1587.463,-557.3117;Inherit;False;Property;_Float2;Float 2;1;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;26;-1640.747,-864.3916;Inherit;False;Property;_Disparition;Disparition;3;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;27;-1240.16,-732.5248;Inherit;False;Property;_Float5;Float 5;4;0;Create;True;0;0;False;0;False;0.1;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;21;-1384.152,-1223.185;Inherit;True;Property;_SpellRecoverSparks;SpellRecoverSparks;2;0;Create;True;0;0;False;0;False;-1;80e8a43671735a543ac031d2a3eaa0f3;80e8a43671735a543ac031d2a3eaa0f3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;40;-101.088,-749.9556;Inherit;False;Property;_Color0;Color 0;6;0;Create;True;0;0;False;0;False;1,0.7771496,0.4669811,0;1,0.7771496,0.4669811,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=C4787F25AE231C4098F5715E5105738995C4DD52