...
Shader "WUXIN_BaseLaser"
{
	Properties
	{
		...
		[ASEEnd]_Float1("Float 1", Float) = 0.1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float smoothstepResult6 = smoothstep( _Float0 , ( _Float0 + _Float1 ) , ( 1.0 - texCoord5.y ));
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = float3( 0.5, 0.5, 0.5 );
				float Alpha = smoothstepResult6;
...
/*ASEBEGIN
Version=18707
1920;0;1920;1019;1343.845;367.8773;1;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;5;-959.8956,-19.40543;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;9;-837.1332,222.9897;Inherit;False;Property;_Float1;Float 1;1;0;Create;True;0;0;False;0;False;0.1;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;8;-838.9332,147.1898;Inherit;False;Property;_Float0;Float 0;0;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;7;-736.2107,29.43439;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;10;-693.8447,203.1227;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;6;-551.7956,29.59459;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=84ED28E92CAA2A2CD6FEE054B28FFD8DE4089EDD