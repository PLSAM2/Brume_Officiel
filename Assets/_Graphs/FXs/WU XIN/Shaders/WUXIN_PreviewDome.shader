	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float lerpResult52 = lerp( 1.0 , -1.0 , _FillAmount);
				...
				float4 lerpResult131 = lerp( ( ( CalculateContrast(_Float19,tex2D( _TextureSample7, texCoord141 )) + _Float7 ) * _Color3 ) , lerpResult94 , smoothstepResult55);
...
/*ASEBEGIN
Version=18707
1065;376;718;297;4824.504;-304.5959;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;45;-3904.297,704.6695;Inherit;False;Property;_FillAmount;FillAmount;17;0;Create;True;0;0;False;0;False;0;0.352;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;95;-2120.847,1828.573;Inherit;False;Property;_Color2;Color 2;28;0;Create;True;0;0;False;0;False;0,0,0,0;0.1433781,0.169811,0.1519688,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;133;-2572.27,1277.154;Inherit;False;Property;_Float7;Float 7;23;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;137;-2877.27,1215.154;Inherit;False;Property;_Float19;Float 19;21;0;Create;True;0;0;False;0;False;1.5;1.5;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=E68EE2C59428A73E77B58BCC3C2CD608BCC6C52D