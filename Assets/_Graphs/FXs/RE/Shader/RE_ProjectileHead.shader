	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 lerpResult52 = lerp( ( ( tex2DNode100.r + 0.4 ) * ( lerpResult70 * ( 1.0 - step( ( saturate( max( blendOpSrc127, blendOpDest127 ) )) , 0.03 ) ) ) ) , color73 , ( 1.0 - step( saturate( ( fresnelNode50 / tex2D( _TextureSample0, panner67 ).r ) ) , _Float6 ) ));
...
/*ASEBEGIN
Version=18707
1920;0;1920;1019;357.1881;1259.416;1;True;False
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;134;251.1347,-1059.525;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;135;1044.965,-718.1273;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0.4;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=F586B52C5BA9101B4F7B52EE3A2F82C5DDBBDBAF