	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 texCoord220 = IN.ase_texcoord3.xy * temp_cast_2 + float2( 0,0 );
				...
				float2 temp_cast_6 = (_MainTrail_Noise_Tiling).xx;
				float2 appendResult67 = (float2(_MainTrail_Noise_Speed , 0.0));
				float2 panner68 = ( 1.0 * _Time.y * appendResult67 + float2( 0,0 ));
				float2 texCoord69 = IN.ase_texcoord3.xy * temp_cast_6 + panner68;
				float2 temp_cast_7 = (( _MainTrail_Noise_Tiling / 2.0 )).xx;
				float2 texCoord126 = IN.ase_texcoord3.xy * temp_cast_7 + float2( 0,0 );
				float blendOpSrc129 = tex2D( _MainTrail_Noise, texCoord69 ).r;
				float blendOpDest129 = tex2D( _MainTrail_Noise, texCoord126 ).r;
				float4 temp_cast_8 = (( saturate( (( blendOpDest129 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest129 ) * ( 1.0 - blendOpSrc129 ) ) : ( 2.0 * blendOpDest129 * blendOpSrc129 ) ) ))).xxxx;
				float2 panner80 = ( 1.0 * _Time.y * _MainTrail_TexturePanner + ( float4( _MainTrail_Offset, 0.0 , 0.0 ) + ( saturate( ( CalculateContrast(_MainTrail_Noise_Contrast,temp_cast_8) + _MainTrail_Noise_Add ) ) * float4( texCoord76, 0.0 , 0.0 ) ) ).rg);
				...
				float2 temp_cast_11 = (_Opacity_Noise_Tiling).xx;
				float2 texCoord146 = IN.ase_texcoord3.xy * temp_cast_11 + float2( 0,0 );
				float2 panner147 = ( 1.0 * _Time.y * float2( 0.5,0 ) + texCoord146);
				float4 temp_cast_12 = (tex2D( _Opacity_Noise, panner147 ).r).xxxx;
				float2 temp_cast_13 = (_AnisotropicNoise_Tiling).xx;
				float2 texCoord178 = IN.ase_texcoord3.xy * temp_cast_13 + float2( 0,0 );
				float2 panner189 = ( 1.0 * _Time.y * _AnisotropicNoise_Panner + texCoord178);
				float smoothstepResult181 = smoothstep( _AnisotropicNoise_Step , ( _AnisotropicNoise_Step + _AnisotropicNoise_Smoothstep ) , ( CalculateContrast(_AnisotropicNoise_Mask_Contrast,temp_cast_12).r + tex2D( _TextureSample4, panner189 ).r ));
...
/*ASEBEGIN
Version=18707
1920;0;1920;1019;6323.624;-1339.1;4.08305;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;103;-3999.981,-62.73874;Inherit;False;Property;_MainTrail_Noise_Tiling;MainTrail_Noise_Tiling;8;0;Create;True;0;0;False;0;False;1;0.42;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;161;-4967.155,1214.859;Inherit;False;4727.625;3134.803;Opacity;50;215;209;162;137;63;188;199;64;62;181;160;200;194;175;184;210;196;174;204;176;198;206;203;189;195;214;178;208;207;190;197;142;213;182;147;148;146;212;149;217;218;220;221;223;224;225;226;227;228;222;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;105;-2615.655,194.2872;Inherit;False;Property;_MainTrail_Noise_Contrast;MainTrail_Noise_Contrast;10;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;73;-2315.701,199.8613;Inherit;False;Property;_MainTrail_Noise_Add;MainTrail_Noise_Add;12;0;Create;True;0;0;False;0;False;0.84;0.84;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;74;-2173.184,603.375;Inherit;False;Property;_MainTrail_TilingUV;MainTrail_TilingUV;13;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;223;-4171.674,1980.14;Inherit;False;Property;_Shape_Noise_Contrast;Shape_Noise_Contrast;9;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;217;-4249.61,1737.122;Inherit;True;Property;_TextureSample0;Texture Sample 0;6;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;70;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;95;-1636.161,-91.23935;Inherit;False;Property;_MainTrail_Offset;MainTrail_Offset;15;0;Create;True;0;0;False;0;False;0,0;-0.5,0.07;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;149;-3102.685,3065.226;Inherit;False;Property;_Opacity_Noise_Tiling;Opacity_Noise_Tiling;17;0;Create;True;0;0;False;0;False;0.84;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;225;-3871.719,1985.714;Inherit;False;Property;_Shape_Noise_Add;Shape_Noise_Add;11;0;Create;True;0;0;False;0;False;0.88;0.88;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;212;-3070.401,2694.41;Inherit;False;Property;_WaveSpeed;WaveSpeed;28;0;Create;True;0;0;False;0;False;4;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;82;-1291.109,742.8208;Inherit;False;Property;_MainTrail_TexturePanner;MainTrail_TexturePanner;14;0;Create;True;0;0;False;0;False;1,0;1,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;182;-2628.48,3533.045;Inherit;False;Property;_AnisotropicNoise_Tiling;AnisotropicNoise_Tiling;19;0;Create;True;0;0;False;0;False;1;0.8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;190;-2391.108,3679.273;Inherit;False;Property;_AnisotropicNoise_Panner;AnisotropicNoise_Panner;22;0;Create;True;0;0;False;0;False;0.1,0;1,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;197;-2064.387,3277.526;Inherit;False;Property;_AnisotropicNoise_Mask_Contrast;AnisotropicNoise_Mask_Contrast;23;0;Create;True;0;0;False;0;False;-0.7;-0.49;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;207;-2970.635,2306.823;Inherit;False;Property;_Float2;Float 2;24;0;Create;True;0;0;False;0;False;0.1;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;208;-2968.635,2382.823;Inherit;False;Property;_Float3;Float 3;26;0;Create;True;0;0;False;0;False;0.13;0.13;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;142;-2313.772,3061.246;Inherit;True;Property;_Opacity_Noise;Opacity_Noise;16;0;Create;True;0;0;False;0;False;-1;1cb5d7a8b79999d4b8356e740bbf6667;1cb5d7a8b79999d4b8356e740bbf6667;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;203;-2534.521,2496.981;Inherit;False;Property;_Float1;Float 1;25;0;Create;True;0;0;False;0;False;1;0.48;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;184;-1876.52,3796.089;Inherit;False;Property;_AnisotropicNoise_Smoothstep;AnisotropicNoise_Smoothstep;21;0;Create;True;0;0;False;0;False;0.01;0.01;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;176;-1830.222,3698.507;Inherit;False;Property;_AnisotropicNoise_Step;AnisotropicNoise_Step;20;0;Create;True;0;0;False;0;False;0.17;0.23;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;174;-1903.571,3481.78;Inherit;True;Property;_TextureSample4;Texture Sample 4;18;0;Create;True;0;0;False;0;False;-1;b7b6180d660771e4ca7b20e22b7a8c51;b7b6180d660771e4ca7b20e22b7a8c51;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=0C1A53AA2292793A7EEC76F90B15E2F485DA8861