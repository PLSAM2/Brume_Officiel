...
Shader "BrumeVolume1"
{
	Properties
	{
		...
		[ASEBegin]_BrumeTexture_Tiling("BrumeTexture_Tiling", Float) = 2
		...
		[Header(Light Normal)]_LightImpact("LightImpact", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float lerpResult449 = lerp( 1.0 , normal_LightDir180 , _LightImpact);
				float2 temp_cast_0 = (_BrumeTexture_Tiling).xx;
...
/*ASEBEGIN
Version=18707
1920;0;1920;1019;7832.195;5383.179;6.559433;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;580;-3465.739,-2596.507;Inherit;False;1687.653;438.0964;DepthFade;10;721;574;726;569;719;718;568;708;728;727;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;569;-2988.408,-2405.903;Inherit;False;Property;_DepthFade_Distance;DepthFade_Distance;19;0;Create;True;0;0;False;1;Header(Depth Fade);False;1;1.06;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;727;-2639.957,-2343.464;Inherit;False;Property;_Float1;Float 1;21;0;Create;True;0;0;False;0;False;0;0.38;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=3B682A89D779C9AAE7A202E8E5797BAD35C164FB