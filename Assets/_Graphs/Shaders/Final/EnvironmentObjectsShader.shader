...
Shader "EnvironmentObjectsShader"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			void TriplanarWeights229_g99( float3 WorldNormal, out float W0, out float W1, out float W2 )
			{
			...
			void TriplanarWeights229_g96( float3 WorldNormal, out float W0, out float W1, out float W2 )
			{
				half3 weights = max( abs( WorldNormal.xyz ), 0.000001 );
				weights /= ( weights.x + weights.y + weights.z ).xxx;
				W0 = weights.x;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float localStochasticTiling216_g99 = ( 0.0 );
				float2 temp_cast_3 = (_PaintGrunge_Tiling).xx;
				float2 temp_output_104_0_g99 = temp_cast_3;
				float3 temp_output_80_0_g99 = WorldPosition;
				float2 Triplanar_UV050_g99 = ( temp_output_104_0_g99 * (temp_output_80_0_g99).zy );
				float2 UV216_g99 = Triplanar_UV050_g99;
				float2 UV1216_g99 = float2( 0,0 );
				float2 UV2216_g99 = float2( 0,0 );
				float2 UV3216_g99 = float2( 0,0 );
				float W1216_g99 = 0.0;
				float W2216_g99 = 0.0;
				float W3216_g99 = 0.0;
				StochasticTiling( UV216_g99 , UV1216_g99 , UV2216_g99 , UV3216_g99 , W1216_g99 , W2216_g99 , W3216_g99 );
				float Input_Index184_g99 = 1.0;
				float2 temp_output_280_0_g99 = ddx( Triplanar_UV050_g99 );
				float2 temp_output_275_0_g99 = ddy( Triplanar_UV050_g99 );
				float localTriplanarWeights229_g99 = ( 0.0 );
				float3 ase_worldNormal = IN.ase_texcoord4.xyz;
				float3 WorldNormal229_g99 = ase_worldNormal;
				float W0229_g99 = 0.0;
				float W1229_g99 = 0.0;
				float W2229_g99 = 0.0;
				TriplanarWeights229_g99( WorldNormal229_g99 , W0229_g99 , W1229_g99 , W2229_g99 );
				float localStochasticTiling215_g99 = ( 0.0 );
				float2 Triplanar_UV164_g99 = ( temp_output_104_0_g99 * (temp_output_80_0_g99).zx );
				float2 UV215_g99 = Triplanar_UV164_g99;
				float2 UV1215_g99 = float2( 0,0 );
				float2 UV2215_g99 = float2( 0,0 );
				float2 UV3215_g99 = float2( 0,0 );
				float W1215_g99 = 0.0;
				float W2215_g99 = 0.0;
				float W3215_g99 = 0.0;
				StochasticTiling( UV215_g99 , UV1215_g99 , UV2215_g99 , UV3215_g99 , W1215_g99 , W2215_g99 , W3215_g99 );
				float2 temp_output_242_0_g99 = ddx( Triplanar_UV164_g99 );
				float2 temp_output_247_0_g99 = ddy( Triplanar_UV164_g99 );
				float localStochasticTiling201_g99 = ( 0.0 );
				float2 Triplanar_UV271_g99 = ( temp_output_104_0_g99 * (temp_output_80_0_g99).xy );
				float2 UV201_g99 = Triplanar_UV271_g99;
				float2 UV1201_g99 = float2( 0,0 );
				float2 UV2201_g99 = float2( 0,0 );
				float2 UV3201_g99 = float2( 0,0 );
				float W1201_g99 = 0.0;
				float W2201_g99 = 0.0;
				float W3201_g99 = 0.0;
				StochasticTiling( UV201_g99 , UV1201_g99 , UV2201_g99 , UV3201_g99 , W1201_g99 , W2201_g99 , W3201_g99 );
				float2 temp_output_214_0_g99 = ddx( Triplanar_UV271_g99 );
				float2 temp_output_258_0_g99 = ddy( Triplanar_UV271_g99 );
				float4 Output_TriplanarArray296_g99 = ( ( ( ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TextureArray_Grunges, sampler_TextureArray_Grunges, UV1216_g99,Input_Index184_g99, temp_output_280_0_g99, temp_output_275_0_g99 ) * W1216_g99 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TextureArray_Grunges, sampler_TextureArray_Grunges, UV2216_g99,Input_Index184_g99, temp_output_280_0_g99, temp_output_275_0_g99 ) * W2216_g99 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TextureArray_Grunges, sampler_TextureArray_Grunges, UV3216_g99,Input_Index184_g99, temp_output_280_0_g99, temp_output_275_0_g99 ) * W3216_g99 ) ) * W0229_g99 ) + ( W1229_g99 * ( ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TextureArray_Grunges, sampler_TextureArray_Grunges, UV1215_g99,Input_Index184_g99, temp_output_242_0_g99, temp_output_247_0_g99 ) * W1215_g99 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TextureArray_Grunges, sampler_TextureArray_Grunges, UV2215_g99,Input_Index184_g99, temp_output_242_0_g99, temp_output_247_0_g99 ) * W2215_g99 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TextureArray_Grunges, sampler_TextureArray_Grunges, UV3215_g99,Input_Index184_g99, temp_output_242_0_g99, temp_output_247_0_g99 ) * W3215_g99 ) ) ) + ( W2229_g99 * ( ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TextureArray_Grunges, sampler_TextureArray_Grunges, UV1201_g99,Input_Index184_g99, temp_output_214_0_g99, temp_output_258_0_g99 ) * W1201_g99 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TextureArray_Grunges, sampler_TextureArray_Grunges, UV2201_g99,Input_Index184_g99, temp_output_214_0_g99, temp_output_258_0_g99 ) * W2201_g99 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TextureArray_Grunges, sampler_TextureArray_Grunges, UV3201_g99,Input_Index184_g99, temp_output_214_0_g99, temp_output_258_0_g99 ) * W3201_g99 ) ) ) );
				float lerpResult1831 = lerp( 1.0 , ( CalculateContrast(_PaintGrunge_Contrast,Output_TriplanarArray296_g99) * _PaintGrunge_Multiply ).r , _PaintGrunge);
				...
				float2 Input_UV145_g95 = texCoord1755;
				...
				float Input_Index184_g95 = 3.0;
				float2 temp_output_172_0_g95 = ddx( Input_UV145_g95 );
				float2 temp_output_182_0_g95 = ddy( Input_UV145_g95 );
				float4 Output_2DArray294_g95 = ( ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TextureArray_Grunges, sampler_TextureArray_Grunges, UV1171_g95,Input_Index184_g95, temp_output_172_0_g95, temp_output_182_0_g95 ) * W1171_g95 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TextureArray_Grunges, sampler_TextureArray_Grunges, UV2171_g95,Input_Index184_g95, temp_output_172_0_g95, temp_output_182_0_g95 ) * W2171_g95 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TextureArray_Grunges, sampler_TextureArray_Grunges, UV3171_g95,Input_Index184_g95, temp_output_172_0_g95, temp_output_182_0_g95 ) * W3171_g95 ) );
				float grayscale1115 = Luminance(CalculateContrast(_IB_NormalInBrumeGrunge_Contrast,Output_2DArray294_g95).rgb);
				...
				float localStochasticTiling216_g96 = ( 0.0 );
				float2 appendResult2140 = (float2(_IB_TerrainBlendingNoise_Tiling , _IB_TerrainBlendingNoise_Tiling));
				float2 temp_output_104_0_g96 = appendResult2140;
				float3 temp_output_80_0_g96 = WorldPosition;
				float2 Triplanar_UV050_g96 = ( temp_output_104_0_g96 * (temp_output_80_0_g96).zy );
				float2 UV216_g96 = Triplanar_UV050_g96;
				float2 UV1216_g96 = float2( 0,0 );
				float2 UV2216_g96 = float2( 0,0 );
				float2 UV3216_g96 = float2( 0,0 );
				float W1216_g96 = 0.0;
				float W2216_g96 = 0.0;
				float W3216_g96 = 0.0;
				StochasticTiling( UV216_g96 , UV1216_g96 , UV2216_g96 , UV3216_g96 , W1216_g96 , W2216_g96 , W3216_g96 );
				float Input_Index184_g96 = 3.0;
				float2 temp_output_280_0_g96 = ddx( Triplanar_UV050_g96 );
				float2 temp_output_275_0_g96 = ddy( Triplanar_UV050_g96 );
				float localTriplanarWeights229_g96 = ( 0.0 );
				float3 WorldNormal229_g96 = ase_worldNormal;
				float W0229_g96 = 0.0;
				float W1229_g96 = 0.0;
				float W2229_g96 = 0.0;
				TriplanarWeights229_g96( WorldNormal229_g96 , W0229_g96 , W1229_g96 , W2229_g96 );
				float localStochasticTiling215_g96 = ( 0.0 );
				float2 Triplanar_UV164_g96 = ( temp_output_104_0_g96 * (temp_output_80_0_g96).zx );
				float2 UV215_g96 = Triplanar_UV164_g96;
				float2 UV1215_g96 = float2( 0,0 );
				float2 UV2215_g96 = float2( 0,0 );
				float2 UV3215_g96 = float2( 0,0 );
				float W1215_g96 = 0.0;
				float W2215_g96 = 0.0;
				float W3215_g96 = 0.0;
				StochasticTiling( UV215_g96 , UV1215_g96 , UV2215_g96 , UV3215_g96 , W1215_g96 , W2215_g96 , W3215_g96 );
				float2 temp_output_242_0_g96 = ddx( Triplanar_UV164_g96 );
				float2 temp_output_247_0_g96 = ddy( Triplanar_UV164_g96 );
				float localStochasticTiling201_g96 = ( 0.0 );
				float2 Triplanar_UV271_g96 = ( temp_output_104_0_g96 * (temp_output_80_0_g96).xy );
				float2 UV201_g96 = Triplanar_UV271_g96;
				float2 UV1201_g96 = float2( 0,0 );
				float2 UV2201_g96 = float2( 0,0 );
				float2 UV3201_g96 = float2( 0,0 );
				float W1201_g96 = 0.0;
				float W2201_g96 = 0.0;
				float W3201_g96 = 0.0;
				StochasticTiling( UV201_g96 , UV1201_g96 , UV2201_g96 , UV3201_g96 , W1201_g96 , W2201_g96 , W3201_g96 );
				float2 temp_output_214_0_g96 = ddx( Triplanar_UV271_g96 );
				float2 temp_output_258_0_g96 = ddy( Triplanar_UV271_g96 );
				float4 Output_TriplanarArray296_g96 = ( ( ( ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TextureArray_Noises, sampler_TextureArray_Noises, UV1216_g96,Input_Index184_g96, temp_output_280_0_g96, temp_output_275_0_g96 ) * W1216_g96 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TextureArray_Noises, sampler_TextureArray_Noises, UV2216_g96,Input_Index184_g96, temp_output_280_0_g96, temp_output_275_0_g96 ) * W2216_g96 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TextureArray_Noises, sampler_TextureArray_Noises, UV3216_g96,Input_Index184_g96, temp_output_280_0_g96, temp_output_275_0_g96 ) * W3216_g96 ) ) * W0229_g96 ) + ( W1229_g96 * ( ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TextureArray_Noises, sampler_TextureArray_Noises, UV1215_g96,Input_Index184_g96, temp_output_242_0_g96, temp_output_247_0_g96 ) * W1215_g96 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TextureArray_Noises, sampler_TextureArray_Noises, UV2215_g96,Input_Index184_g96, temp_output_242_0_g96, temp_output_247_0_g96 ) * W2215_g96 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TextureArray_Noises, sampler_TextureArray_Noises, UV3215_g96,Input_Index184_g96, temp_output_242_0_g96, temp_output_247_0_g96 ) * W3215_g96 ) ) ) + ( W2229_g96 * ( ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TextureArray_Noises, sampler_TextureArray_Noises, UV1201_g96,Input_Index184_g96, temp_output_214_0_g96, temp_output_258_0_g96 ) * W1201_g96 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TextureArray_Noises, sampler_TextureArray_Noises, UV2201_g96,Input_Index184_g96, temp_output_214_0_g96, temp_output_258_0_g96 ) * W2201_g96 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TextureArray_Noises, sampler_TextureArray_Noises, UV3201_g96,Input_Index184_g96, temp_output_214_0_g96, temp_output_258_0_g96 ) * W3201_g96 ) ) ) );
				float4 clampResult2044 = clamp( ( TerrainBlending2034 / ( _IB_TerrainBlending_BlendThickness * Output_TriplanarArray296_g96 ) ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
...
/*ASEBEGIN
Version=18707
1920;0;1920;1019;15515.82;5824.682;9.081672;True;False
...
Node;AmplifyShaderEditor.FunctionNode;1382;-6350.948,-3711.748;Inherit;False;Procedural Sample;-1;;99;f5379ff72769e2b4495e5ce2f004d8d4;2,157,3,315,3;7;82;SAMPLER2D;0;False;158;SAMPLER2DARRAY;0;False;183;FLOAT;0;False;5;FLOAT2;0,0;False;80;FLOAT3;0,0,0;False;104;FLOAT2;1,0;False;74;SAMPLERSTATE;0;False;5;COLOR;0;FLOAT;32;FLOAT;33;FLOAT;34;FLOAT;35
...
Node;AmplifyShaderEditor.FunctionNode;2040;2566.337,-873.7946;Inherit;False;Procedural Sample;-1;;96;f5379ff72769e2b4495e5ce2f004d8d4;2,157,3,315,3;7;82;SAMPLER2D;0;False;158;SAMPLER2DARRAY;0;False;183;FLOAT;0;False;5;FLOAT2;0,0;False;80;FLOAT3;0,0,0;False;104;FLOAT2;1,0;False;74;SAMPLERSTATE;0;False;5;COLOR;0;FLOAT;32;FLOAT;33;FLOAT;34;FLOAT;35
...
Node;AmplifyShaderEditor.FunctionNode;1752;2563.58,-3435.858;Inherit;False;Procedural Sample;-1;;95;f5379ff72769e2b4495e5ce2f004d8d4;2,157,1,315,1;7;82;SAMPLER2D;0;False;158;SAMPLER2DARRAY;0;False;183;FLOAT;0;False;5;FLOAT2;0,0;False;80;FLOAT3;0,0,0;False;104;FLOAT2;1,0;False;74;SAMPLERSTATE;0;False;5;COLOR;0;FLOAT;32;FLOAT;33;FLOAT;34;FLOAT;35
...
ASEEND*/
//CHKSM=DB3813266866342982287C7117517C2CB202A4D2