...
Shader "EnvironmentObjectsShader"
{
	Properties
	{
		...
		_Normal_Level("Normal_Level", Float) = 1
		...
		_UV2_Normal_Level("UV2_Normal_Level", Float) = 1
		...
		[Header(In Brume)]_IB_ColorCorrection("IB_ColorCorrection", Color) = (1,1,1,0)
		_IB_BackColor("IB_BackColor", Color) = (1,1,1,0)
		_IB_ColorShadow("IB_ColorShadow", Color) = (0.5283019,0.5283019,0.5283019,0)
		_IB_Noise_Tiling("IB_Noise_Tiling", Float) = 1
		...
		_IBNormalDrippingNoise_Step("IBNormalDrippingNoise_Step", Range( 0 , 1)) = 0.45
		_IB_NormalDrippingNoise_Tiling("IB_NormalDrippingNoise_Tiling", Float) = 1
		_IB_NormalDrippingNoise_Offset("IB_NormalDrippingNoise_Offset", Vector) = (0,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			float2 _IB_NormalDrippingNoise_Offset;
			...
			float _IBNormalDrippingNoise_Step;
			float _IB_NormalDrippingNoise_Smoothstep;
			float _IB_NormalDrippingNoise_Tiling;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 unpack2126 = UnpackNormalScale( SAMPLE_TEXTURE2D_ARRAY( _TextureArray_Textures, sampler_TextureArray_Textures, texCoord1622,1.0 ), _Normal_Level );
				unpack2126.z = lerp( 1, unpack2126.z, saturate(_Normal_Level) );
				...
				float3 unpack2128 = UnpackNormalScale( SAMPLE_TEXTURE2D_ARRAY( _UV2_TextureArray_Textures, sampler_UV2_TextureArray_Textures, texCoord2067,1.0 ), _UV2_Normal_Level );
				unpack2128.z = lerp( 1, unpack2128.z, saturate(_UV2_Normal_Level) );
				float3 Object_Normal_Texture_UV22073 = unpack2128;
				float3 lerpResult2082 = lerp( BlankNormal2113 , Object_Normal_Texture_UV22073 , Switch_UV_22074);
				float3 temp_output_2111_0 = BlendNormal( Object_Normal_Texture1454 , lerpResult2082 );
				...
				float2 temp_cast_13 = (_Noise_Tiling).xx;
				float2 texCoord565 = IN.ase_texcoord5.xy * temp_cast_13 + float2( 0,0 );
				...
				float4 temp_cast_14 = (( saturate( ( 1.0 - ( ( 1.0 - blendOpDest444) / max( blendOpSrc444, 0.00001) ) ) ))).xxxx;
				float4 blendOpSrc449 = temp_cast_14;
				...
				float2 temp_cast_15 = (_IB_Noise_Tiling).xx;
				float2 texCoord1943 = IN.ase_texcoord5.xy * temp_cast_15 + float2( 0,0 );
				...
				float2 temp_cast_16 = (_IB_ShadowInBrumeGrunge_Tiling).xx;
				float2 texCoord1754 = IN.ase_texcoord5.xy * temp_cast_16 + float2( 0,0 );
				...
				float grayscale1119 = Luminance(CalculateContrast(_IB_ShadowInBrumeGrunge_Contrast,Output_2DArray294_g46).rgb);
				...
				float2 temp_cast_18 = (_IB_NormalInBrumeGrunge_Tiling).xx;
				float2 texCoord1755 = IN.ase_texcoord5.xy * temp_cast_18 + float2( 0,0 );
				...
				float grayscale1115 = Luminance(CalculateContrast(_IB_NormalInBrumeGrunge_Contrast,Output_2DArray294_g45).rgb);
				float NormalInBrumeGrunge1247 = grayscale1115;
				float3 NormalMixedUV22091 = temp_output_2111_0;
				float grayscale1105 = (NormalMixedUV22091.r + NormalMixedUV22091.g + NormalMixedUV22091.b) / 3;
				float temp_output_1106_0 = step( grayscale1105 , _IBNormalDrippingNoise_Step );
				float smoothstepResult1179 = smoothstep( _IBNormalDrippingNoise_Step , ( _IBNormalDrippingNoise_Step + _IB_NormalDrippingNoise_Smoothstep ) , grayscale1105);
				float4 temp_cast_20 = (( 1.0 - smoothstepResult1179 )).xxxx;
				float2 temp_cast_21 = (_IB_NormalDrippingNoise_Tiling).xx;
				float2 texCoord1184 = IN.ase_texcoord5.xy * temp_cast_21 + _IB_NormalDrippingNoise_Offset;
				float4 temp_output_1186_0 = ( temp_output_1106_0 + ( temp_cast_20 - SAMPLE_TEXTURE2D_ARRAY( _TextureArray_Noises, sampler_TextureArray_Noises, texCoord1184,2.0 ) ) );
				float4 temp_cast_22 = (( 1.0 - smoothstepResult1179 )).xxxx;
				...
				float IB_Edges1994 = (0.0 + (( ( temp_output_1979_0 * ( Object_Albedo_Texture_UV22072.r + _IB_Edges_Modif1 ) ) + ( ( 1.0 - temp_output_1979_0 ) * ( Object_Albedo_Texture_UV22072.r + _IB_Edges_Modif2 ) ) ) - 0.0) * (1.0 - 0.0) / (1.0 - 0.0));
				float4 temp_cast_23 = (IB_Edges1994).xxxx;
				float4 blendOpSrc1989 = ( max( blendOpSrc1162, blendOpDest1162 ) * NormalDrippingGrunge1251 );
				float4 blendOpDest1989 = temp_cast_23;
				float4 EndInBrume901 = ( _IB_ColorCorrection * (float4( 0,0,0,0 ) + (( saturate( ( blendOpSrc1989 * blendOpDest1989 ) )) - float4( 0,0,0,0 )) * (float4( 1,1,1,1 ) - float4( 0,0,0,0 )) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 ))) );
				float4 temp_cast_24 = (worldY1344).xxxx;
				float4 temp_cast_25 = (TB_OFFSET_Y).xxxx;
				...
				float4 temp_cast_26 = (_IB_TerrainBlending_Falloff).xxxx;
				float4 clampResult2046 = clamp( pow( clampResult2044 , temp_cast_26 ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				...
				float4 temp_cast_27 = (normal_LightDir23).xxxx;
				float4 lerpResult1403 = lerp( lerpResult955 , temp_cast_27 , _LightDebug);
...
/*ASEBEGIN
Version=18707
1920;0;1920;1019;-5682.473;3249.706;1;True;False
...
Node;AmplifyShaderEditor.TexturePropertyNode;1881;-8811.957,-2077.658;Inherit;True;Property;_TextureArray_Noises;TextureArray_Noises;13;0;Create;True;0;0;False;0;False;668ed38e9d9e517458c599bfa078a81c;829b1744df5e7e1438fda8b5bb926ccc;False;white;Auto;Texture2DArray;-1;0;2;SAMPLER2DARRAY;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;1308;-6481.101,1320.633;Inherit;False;Property;_WindWave_Frequency;WindWave_Frequency;93;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;1310;-6459.711,1576.864;Inherit;False;Property;_WindWave_Min_Speed;WindWave_Min_Speed;92;0;Create;True;0;0;False;0;False;0.05,0;0.05,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;1311;-6313.236,1119.05;Inherit;False;Property;_WindWave_Speed;WindWave_Speed;91;0;Create;True;0;0;False;0;False;0.1,0;0.1,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;1316;-5760.191,1183.936;Inherit;False;Property;_Wind_Texture_Tiling;Wind_Texture_Tiling;86;0;Create;True;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1364;-658.3721,-3226.122;Inherit;False;Property;_TerrainBlending_Falloff;TerrainBlending_Falloff;50;0;Create;True;0;0;False;0;False;0;30;0;30;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1321;-4864.397,1436.076;Inherit;False;Property;_Wind_Density;Wind_Density;89;0;Create;True;0;0;False;0;False;0.2;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2099;-4905.407,1255.021;Inherit;False;Property;_Wind_Texture_Contrast;Wind_Texture_Contrast;87;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1324;-4248.583,1241.312;Inherit;False;Property;_Wind_Strength;Wind_Strength;90;0;Create;True;0;0;False;0;False;2;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1767;-6481.631,1903.098;Inherit;False;Property;_TerrainBlending_Opacity;TerrainBlending_Opacity;47;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1314;-3590.149,1526.735;Inherit;False;Property;_Wind_Direction;Wind_Direction;88;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1408;-8448.458,9.939123;Inherit;False;Property;_WindVertexDisplacement;WindVertexDisplacement?;85;0;Create;True;0;0;False;1;Header(Wind);False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;1993;5729.438,-3164.017;Inherit;False;2271.157;937.1863;Edges;14;1976;1991;1981;1992;1966;1985;1979;1980;1977;1983;1990;1994;2130;2131;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1546;-5511.542,2990.943;Inherit;False;Property;_DepthFade_ClampMin;DepthFade_ClampMin;101;0;Create;True;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1567;-2314.428,-1111.733;Inherit;False;Property;_TopTex_Smoothstep;TopTex_Smoothstep;58;0;Create;True;0;0;False;0;False;0.3;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1833;-5102.637,-3559.773;Inherit;False;Property;_PaintGrunge;PaintGrunge?;26;0;Create;True;0;0;False;1;Header(PaintGrunge);False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;1531;-6522.646,2585.664;Inherit;True;Property;_DepthFade_Dither_Texture;DepthFade_Dither_Texture;96;0;Create;True;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;463;-6598.551,-4460.616;Inherit;False;Property;_AnimatedGrunge_Tiling;AnimatedGrunge_Tiling;21;0;Create;True;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1412;-6089.449,-4465.237;Inherit;False;Property;_IsGrungeAnimated;IsGrungeAnimated?;20;0;Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1535;-5511.806,3075.435;Inherit;False;Property;_DepthFade_ClampMax;DepthFade_ClampMax;102;0;Create;True;0;0;False;0;False;0.8;0.8;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1532;-5786.371,2666.917;Inherit;False;Property;_DepthFade_Falloff;DepthFade_Falloff;99;0;Create;True;0;0;False;0;False;3;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1533;-5793.371,2748.917;Inherit;False;Property;_DepthFade_Distance;DepthFade_Distance;100;0;Create;True;0;0;False;0;False;10.5;10.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1543;-6203.082,3077.943;Inherit;False;Property;_DepthFade_Texture;DepthFade_Texture?;95;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1566;-2267.429,-1219.732;Inherit;False;Property;_TopTex_Step;TopTex_Step;57;0;Create;True;0;0;False;0;False;0;0.6;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;1600;-1850.2,-2063.21;Inherit;True;Property;_TopTex_Albedo_Texture;TopTex_ Albedo_Texture;52;0;Create;True;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;526;-4919.349,-4330.476;Inherit;False;Property;_AnimatedGrungeMultiply;AnimatedGrungeMultiply;25;0;Create;True;0;0;False;0;False;1.58;1.58;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1526;-6658.833,2964.437;Inherit;False;Property;_DepthFade_Dither_Tiling;DepthFade_Dither_Tiling;97;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1529;-6237.646,2856.664;Inherit;False;Procedural Sample;-1;;28;f5379ff72769e2b4495e5ce2f004d8d4;2,157,0,315,0;7;82;SAMPLER2D;0;False;158;SAMPLER2DARRAY;0;False;183;FLOAT;0;False;5;FLOAT2;0,0;False;80;FLOAT3;0,0,0;False;104;FLOAT2;1,0;False;74;SAMPLERSTATE;0;False;5;COLOR;0;FLOAT;32;FLOAT;33;FLOAT;34;FLOAT;35
...
Node;AmplifyShaderEditor.RangedFloatNode;665;-6461.598,-4277.863;Inherit;False;Property;_AnimatedGrunge_Flipbook_Columns;AnimatedGrunge_Flipbook_Columns;22;0;Create;True;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;1992;7357.596,-2772.277;Inherit;True;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;1193;3406.801,-2435.374;Inherit;False;Property;_IB_NormalDrippingNoise_Offset;IB_NormalDrippingNoise_Offset;77;0;Create;True;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;2129;-7966.17,-3479.684;Inherit;False;Property;_UV2_Normal_Level;UV2_Normal_Level;16;0;Create;True;0;0;False;0;False;1;-1.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;2081;-6718.242,-2561.547;Inherit;False;Property;_UV2_OutBrume_ColorCorrection;UV2_OutBrume_ColorCorrection;17;0;Create;True;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;1256;8346.056,-4102.941;Inherit;False;Property;_IB_ColorCorrection;IB_ColorCorrection;63;0;Create;True;0;0;False;1;Header(In Brume);False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;1108;3156.019,-2842.959;Inherit;False;Property;_IBNormalDrippingNoise_Step;IBNormalDrippingNoise_Step;75;0;Create;True;0;0;False;0;False;0.45;0.461;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1750;3000.792,-3553.717;Inherit;False;Property;_IB_ShadowInBrumeGrunge_Tiling;IB_ShadowInBrumeGrunge_Tiling;78;0;Create;True;0;0;False;0;False;0.2;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1751;3025.618,-3281.565;Inherit;False;Property;_IB_NormalInBrumeGrunge_Tiling;IB_NormalInBrumeGrunge_Tiling;80;0;Create;True;0;0;False;0;False;0.2;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1117;3900.277,-3650.035;Inherit;False;Property;_IB_ShadowInBrumeGrunge_Contrast;IB_ShadowInBrumeGrunge_Contrast;79;0;Create;True;0;0;False;0;False;-3.38;-30;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1114;3881.005,-3369.197;Inherit;False;Property;_IB_NormalInBrumeGrunge_Contrast;IB_NormalInBrumeGrunge_Contrast;81;0;Create;True;0;0;False;0;False;2.4;-6.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1230;2955.93,-4257.833;Inherit;False;Property;_IB_ShadowDrippingNoise_Smoothstep;IB_ShadowDrippingNoise_Smoothstep;72;0;Create;True;0;0;False;0;False;0.2;0.001;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1182;3136.887,-2742.587;Inherit;False;Property;_IB_NormalDrippingNoise_Smoothstep;IB_NormalDrippingNoise_Smoothstep;74;0;Create;True;0;0;False;0;False;0.01;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;1050;6607.788,-4579.279;Inherit;False;Property;_IB_BackColor;IB_BackColor;64;0;Create;True;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;1191;3413.503,-2522.828;Inherit;False;Property;_IB_NormalDrippingNoise_Tiling;IB_NormalDrippingNoise_Tiling;76;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1954;2953.915,-4428.764;Inherit;False;Property;_IB_ShadowDrippingNoise_SmoothstepAnimated;IB_ShadowDrippingNoise_SmoothstepAnimated;82;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1977;6939.192,-2982.847;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1594;-1481.803,-661.8361;Inherit;False;InstancedProperty;_TopTex_NoiseHoles;TopTex_NoiseHoles?;54;0;Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;1818;-8811.877,-2951.616;Inherit;True;Property;_TextureArray_Grunges;TextureArray_Grunges;12;0;Create;True;0;0;False;0;False;668ed38e9d9e517458c599bfa078a81c;649e428ece482fe499fbfc248f5c6460;False;white;Auto;Texture2DArray;-1;0;2;SAMPLER2DARRAY;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.FunctionNode;2112;-8007.942,401.2925;Inherit;False;NormalCreate;0;;48;e12f7ae19d416b942820e3932b56220f;0;4;1;SAMPLER2D;;False;2;FLOAT2;0,0;False;3;FLOAT;0.5;False;4;FLOAT;2;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2075;-8058.865,295.8423;Inherit;False;Property;_UV_2_;UV_2_?;14;0;Create;True;0;0;False;1;Header(UV 2);False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1465;2960.568,-3107.402;Inherit;False;2091;NormalMixedUV2;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1414;-6197.695,695.1272;Inherit;False;Property;_ScreenBasedNoise;ScreenBasedNoise?;30;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1528;-5788.291,2944.453;Inherit;False;Property;_DepthFade_DitherMultiply;DepthFade_DitherMultiply;98;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1165;2993.088,-4335.258;Inherit;False;Property;_IB_ShadowDrippingNoise_Step;IB_ShadowDrippingNoise_Step;73;0;Create;True;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1981;6947.54,-2607.254;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1836;-4600.862,-4065.742;Inherit;False;Property;_AnimatedGrunge;AnimatedGrunge?;19;0;Create;True;0;0;False;1;Header(AnimatedGrunge);False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1726;-6219.809,-3507.759;Inherit;False;Property;_PaintGrunge_Contrast;PaintGrunge_Contrast;28;0;Create;True;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;1991;6592.833,-2473.831;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;1569;-2965.847,-814.059;Inherit;False;Property;_TopTex_NoiseOffset;TopTex_NoiseOffset;56;0;Create;True;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;1392;654.8813,-4429.892;Inherit;False;Property;_CustomRimLight_Opacity;CustomRimLight_Opacity;62;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1459;-2987.218,-4219.704;Inherit;True;2091;NormalMixedUV2;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1902;635.6772,-3984.347;Inherit;False;Property;_CustomRimLight_Texture;CustomRimLight_Texture?;60;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;2073;-7505.328,-3574.378;Inherit;False;Object_Normal_Texture_UV2;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.Vector2Node;2039;3249.112,-1131.434;Inherit;False;Property;_IB_TerrainBlendingNoise_Tiling;IB_TerrainBlendingNoise_Tiling;68;0;Create;True;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;1935;-2163.304,249.1908;Inherit;False;Property;_IB_Noise_Panner;IB_Noise_Panner;67;0;Create;True;0;0;False;0;False;0.2,-0.1;0.2,-0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;2091;-5608.227,149.2226;Inherit;False;NormalMixedUV2;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;667;-6458.598,-4121.866;Inherit;False;Property;_AnimatedGrunge_Flipbook_Speed;AnimatedGrunge_Flipbook_Speed;24;0;Create;True;0;0;False;0;False;1;6;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;989;6451.979,-4096.746;Inherit;False;Property;_IB_ColorShadow;IB_ColorShadow;65;0;Create;True;0;0;False;0;False;0.5283019,0.5283019,0.5283019,0;0.5283019,0.5283019,0.5283019,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;841;-6750.289,-3037.922;Inherit;False;Property;_OutBrumeColorCorrection;OutBrumeColorCorrection;9;0;Create;True;0;0;False;0;False;1,1,1,0;0.3490196,0.3882353,0.427451,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;1990;6542.852,-3097.89;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1391;666.8824,-4350.892;Inherit;False;Property;_CustomRimLight_Color;CustomRimLight_Color;61;0;Create;True;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;1985;7230.855,-2772.468;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1385;-6749.07,-3428.541;Inherit;False;Property;_PaintGrunge_Tiling;PaintGrunge_Tiling;27;0;Create;True;0;0;False;0;False;1;0.34;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1728;-5810.748,-3474.607;Inherit;False;Property;_PaintGrunge_Multiply;PaintGrunge_Multiply;29;0;Create;True;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2041;3647.089,-1542.251;Inherit;False;Property;_IB_TerrainBlending_BlendThickness;IB_TerrainBlending_BlendThickness;69;0;Create;True;0;0;False;0;False;0;0;0;30;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1994;7704.8,-2776.062;Inherit;False;IB_Edges;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;666;-6457.598,-4199.864;Inherit;False;Property;_AnimatedGrunge_Flipbook_Rows;AnimatedGrunge_Flipbook_Rows;23;0;Create;True;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1382;-6350.948,-3711.748;Inherit;False;Procedural Sample;-1;;44;f5379ff72769e2b4495e5ce2f004d8d4;2,157,3,315,3;7;82;SAMPLER2D;0;False;158;SAMPLER2DARRAY;0;False;183;FLOAT;0;False;5;FLOAT2;0,0;False;80;FLOAT3;0,0,0;False;104;FLOAT2;1,0;False;74;SAMPLERSTATE;0;False;5;COLOR;0;FLOAT;32;FLOAT;33;FLOAT;34;FLOAT;35
Node;AmplifyShaderEditor.RangedFloatNode;2127;-7878.123,-4415.457;Inherit;False;Property;_Normal_Level;Normal_Level;11;0;Create;True;0;0;False;0;False;1;0.7;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1538;-5421.541,2241.856;Inherit;False;Property;_DepthFade;DepthFade?;94;0;Create;True;0;0;False;1;Header(Depth Fade);False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;2065;-8803.613,-3790.832;Inherit;True;Property;_UV2_TextureArray_Textures;UV2_TextureArray_Textures;15;0;Create;True;0;0;False;0;False;668ed38e9d9e517458c599bfa078a81c;c531b95b4ac351b44869b18af95dbb5e;False;white;Auto;Texture2DArray;-1;0;2;SAMPLER2DARRAY;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.Vector2Node;1604;-1779.929,-1864.877;Inherit;False;Property;_TopTex_Tiling;TopTex_Tiling;53;0;Create;True;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.BreakToComponentsNode;2131;6052.522,-3096.34;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.GetLocalVarNode;1598;-2881.858,-1582.888;Inherit;True;2091;NormalMixedUV2;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.LerpOp;2082;-6505.764,-124.5115;Inherit;False;3;0;FLOAT3;1,1,1;False;1;FLOAT3;1,1,1;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1568;-2964.013,-899.0527;Inherit;False;Property;_TopTex_NoiseTiling;TopTex_NoiseTiling;55;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;2051;4998.575,-1944.512;Inherit;False;Property;_IB_TerrainBlending_Color;IB_TerrainBlending_Color;71;0;Create;True;0;0;False;0;False;0.4245283,0.4245283,0.4245283,0;0.4245282,0.4245282,0.4245282,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1966;6218.671,-2991.299;Inherit;False;Property;_IB_Edges_Modif1;IB_Edges_Modif1;83;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2076;-6875.397,-103.2326;Inherit;True;2073;Object_Normal_Texture_UV2;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1936;-2509.017,78.57581;Inherit;False;Property;_IB_Noise_Tiling;IB_Noise_Tiling;66;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1402;-5390.063,-526.0887;Inherit;False;Property;_Specular;Specular?;36;0;Create;True;0;0;False;1;Header(Specular);False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1591;-6107.303,-507.0307;Inherit;False;Property;_TopTex;TopTex?;51;0;Create;True;0;0;False;1;Header(Top Texture);False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1400;-4557.978,-524.37;Inherit;False;Property;_CustomRimLight;CustomRimLight?;59;0;Create;True;0;0;False;1;Header(Custom Rim Light);False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2048;4333.79,-1829.248;Inherit;False;Property;_IB_TerrainBlending_Falloff;IB_TerrainBlending_Falloff;70;0;Create;True;0;0;False;0;False;0;0;0;30;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1607;-6486.462,-613.0308;Inherit;False;1606;TopTexMask;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1983;6286.506,-2375.041;Inherit;False;Property;_IB_Edges_Modif2;IB_Edges_Modif2;84;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=D60C42AAE151D61B0B3DF28BCBAA37C03E7F04D2