	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float localStochasticTiling171_g35 = ( 0.0 );
				float2 temp_cast_25 = (_ShadowInBrumeGrunge_Tiling).xx;
				float2 texCoord1754 = IN.ase_texcoord5.xy * temp_cast_25 + float2( 0,0 );
				float2 Input_UV145_g35 = texCoord1754;
				float2 UV171_g35 = Input_UV145_g35;
				float2 UV1171_g35 = float2( 0,0 );
				float2 UV2171_g35 = float2( 0,0 );
				float2 UV3171_g35 = float2( 0,0 );
				float W1171_g35 = 0.0;
				float W2171_g35 = 0.0;
				float W3171_g35 = 0.0;
				StochasticTiling( UV171_g35 , UV1171_g35 , UV2171_g35 , UV3171_g35 , W1171_g35 , W2171_g35 , W3171_g35 );
				float Input_Index184_g35 = _Float29;
				float2 temp_output_172_0_g35 = ddx( Input_UV145_g35 );
				float2 temp_output_182_0_g35 = ddy( Input_UV145_g35 );
				float4 Output_2DArray294_g35 = ( ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TextureArray_Grunges, sampler_TextureArray_Grunges, UV1171_g35,Input_Index184_g35, temp_output_172_0_g35, temp_output_182_0_g35 ) * W1171_g35 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TextureArray_Grunges, sampler_TextureArray_Grunges, UV2171_g35,Input_Index184_g35, temp_output_172_0_g35, temp_output_182_0_g35 ) * W2171_g35 ) + ( SAMPLE_TEXTURE2D_ARRAY_GRAD( _TextureArray_Grunges, sampler_TextureArray_Grunges, UV3171_g35,Input_Index184_g35, temp_output_172_0_g35, temp_output_182_0_g35 ) * W3171_g35 ) );
				float grayscale1119 = Luminance(CalculateContrast(_ShadowInBrumeGrunge_Contrast,Output_2DArray294_g35).rgb);
...
/*ASEBEGIN
Version=18707
1920;0;1920;1019;7508.958;824.7245;1.301502;True;False
...
Node;AmplifyShaderEditor.ColorNode;1760;-681.3223,-3435.616;Inherit;False;Property;_TerrainBlending_Color;TerrainBlending_Color;40;0;Create;True;0;0;False;0;False;1,1,1,0;0.3679237,0.2556294,0.2412327,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;1749;3575.593,-3751.417;Inherit;False;Procedural Sample;-1;;35;f5379ff72769e2b4495e5ce2f004d8d4;2,157,1,315,1;7;82;SAMPLER2D;0;False;158;SAMPLER2DARRAY;0;False;183;FLOAT;0;False;5;FLOAT2;0,0;False;80;FLOAT3;0,0,0;False;104;FLOAT2;1,0;False;74;SAMPLERSTATE;0;False;5;COLOR;0;FLOAT;32;FLOAT;33;FLOAT;34;FLOAT;35
...
ASEEND*/
//CHKSM=5EA6C4CD2223A230645588AAC58A5E6DFE48DFC7