...
Shader "RE_Shader"
{
	Properties
	{
		...
		_HitColorRed1("HitColorRed", Color) = (1,0,0,0)
		_HitWhite("HitWhite?", Range( 0 , 1)) = 0
		_HitWhiteOpacityMax("HitWhiteOpacityMax", Range( 0 , 1)) = 0.5
		_HitFresnelScale1("HitFresnelScale", Float) = 0
		[ASEEnd]_HitFresnelPower1("HitFresnelPower", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _HitFresnelPower1;
			float _Speed;
			float _Booster;
			float _HitFresnelScale1;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float fresnelNode154 = ( 0.0 + _HitFresnelScale1 * pow( 1.0 - fresnelNdotV154, _HitFresnelPower1 ) );
				...
				float4 lerpResult140 = lerp( lerpResult142 , ( _HitColorRed1 * temp_output_153_0 ) , lerpResult148);
...
Node;AmplifyShaderEditor.RangedFloatNode;155;-1554.365,-33.63443;Inherit;False;Property;_HitFresnelPower1;HitFresnelPower;30;0;Create;True;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;134;-358.2375,535.9274;Inherit;False;Property;_Alpha;Alpha?;15;0;Create;True;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;152;-740.9421,-340.3035;Inherit;False;Property;_HitColorRed1;HitColorRed;26;0;Create;True;0;0;False;0;False;1,0,0,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;156;-1556.365,-113.6343;Inherit;False;Property;_HitFresnelScale1;HitFresnelScale;29;0;Create;True;0;0;False;0;False;0;-1.5;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=0F95AB2995A0547FDCC49F1023D5EE9B4EC3374C