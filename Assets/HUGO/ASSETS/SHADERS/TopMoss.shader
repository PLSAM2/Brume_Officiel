...
Shader "TopMoss"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float2 uv_TexCoord34 = i.uv_texcoord * temp_cast_4 + _NoiseOffset;
			float4 tex2DNode28 = tex2D( _Noise, uv_TexCoord34 );
			float smoothstepResult31 = smoothstep( 0.0 , 0.25 , ( smoothstepResult26 - tex2DNode28.r ));
			float clampResult8 = clamp( ( smoothstepResult31 - step( tex2DNode28.r , 0.34 ) ) , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=18707
0;6;1920;1013;4187.482;-478.1721;1;True;False
...
Node;AmplifyShaderEditor.Vector2Node;51;-3028.482,984.1721;Inherit;False;Property;_NoiseOffset;NoiseOffset;5;0;Create;True;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;35;-3023.648,881.178;Inherit;False;Property;_NoiseTiling;NoiseTiling;2;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;34;-2836.648,904.178;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;9;-2070.663,-580.0173;Inherit;True;Property;_SnowTexture;SnowTexture;0;0;Create;True;0;0;False;0;False;-1;4d5dbc1ba3dda0143a39c6a1fa10a3b9;4d5dbc1ba3dda0143a39c6a1fa10a3b9;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StepOpNode;48;-2109.962,840.2468;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0.34;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;49;-1069.115,464.1575;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=5554245F3E8066EB02D7D865A021D966DDC831A9