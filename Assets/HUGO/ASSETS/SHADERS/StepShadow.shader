...
Shader "StepShadow"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#else
				float4 staticSwitch61 = tex2D( _Object_Roughness, uv_Object_Roughness );
			#endif
...
/*ASEBEGIN
Version=18301
-4;9;1920;1019;4594.838;1923.521;2.216703;True;False
...
ASEEND*/
//CHKSM=3CBD46029705B0BB26B5D0467A73BF7460AC0A6E