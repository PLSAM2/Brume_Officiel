...
Shader "StepShadow"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 temp_cast_1 = (( 1.0 - step( dotResult3 , _Step_Shadow ) )).xxxx;
			float4 blendOpSrc8 = temp_cast_1;
			...
			float3 RGB59 = ( dotResult39 * temp_output_48_0 );
			c.rgb = RGB59;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=18301
-4;9;1920;1019;3879.765;2067.616;2.183983;True;False
...
Node;AmplifyShaderEditor.ColorNode;51;-2779.285,-1523.631;Float;False;Property;_Color0;Color 0;1;0;Create;True;0;0;False;0;False;0.3921569,0.3921569,0.3921569,1;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;31;-1046.13,-1156.535;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=75DEFA73FE4676F63D9F6F89CA0B664F6C4FEA1D