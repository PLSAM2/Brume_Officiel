...
Shader "InkShaderTest"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#endif //aseld
			float dotResult453 = dot( ase_worldNormal , ase_worldlightDir );
			float4 temp_cast_0 = (pow( dotResult453 , -0.11 )).xxxx;
			float4 color494 = IsGammaSpace() ? float4(0.4339623,0.4339623,0.4339623,0) : float4(0.1579265,0.1579265,0.1579265,0);
			float4 blendOpSrc495 = temp_cast_0;
			float4 blendOpDest495 = color494;
			c.rgb = ( 	max( blendOpSrc495, blendOpDest495 ) * ( 1.0 - step( dotResult453 , -0.1 ) ) ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=18301
-4;9;1920;1019;702.6118;-144.2902;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;463;-4347.201,-3200.374;Inherit;False;Property;_PaperGrunge_Tiling;Paper/Grunge_Tiling;13;0;Create;True;0;0;False;0;False;1;3.54;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;450;-2967.445,-1381.246;Inherit;False;Property;_ShadowColor;ShadowColor;11;0;Create;True;0;0;False;0;False;0.8018868,0.8018868,0.8018868,0;0.4622641,0.4622641,0.4622641,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;487;-5356.556,-86.10516;Inherit;False;Property;_Panner;Panner;15;0;Create;True;0;0;False;0;False;0,0;0.2,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;388;-4337.663,-1947.75;Inherit;False;Property;_StepAttenuation;StepAttenuation;9;0;Create;True;0;0;False;0;False;-0.27;-0.59;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;386;-4828.71,-1671.417;Inherit;False;Property;_StepShadow;StepShadow;8;0;Create;True;0;0;False;0;False;0.03;0.26;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;422;-4557.078,-998.7985;Inherit;False;Property;_EdgeRange;EdgeRange;10;0;Create;True;0;0;False;0;False;-0.1;-0.23;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;479;-5629.46,-251.6951;Inherit;False;Property;_Noise_Tiling;Noise_Tiling;14;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;454;-3858.385,-3306.615;Inherit;True;Property;_PaperGrunge_Texture;Paper/Grunge_Texture;12;0;Create;True;0;0;False;0;False;-1;8c8e6bd39f1d3c348a607b675e3dc417;8c8e6bd39f1d3c348a607b675e3dc417;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;0;13;491;0
ASEEND*/
//CHKSM=C27562CD4BF0DCBD86E796B332E65E60A6AF5C5A