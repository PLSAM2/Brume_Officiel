...
Shader "EnvironmentObjectsShader"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			void TriplanarWeights108_g19( float3 WorldNormal, out float W0, out float W1, out float W2 )
			{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float2 texCoord1319 = inputMesh.ase_texcoord.xy * temp_cast_1 + ( ( panner1312 + panner1313 ) * _Wind_Direction );
				float4 temp_cast_2 = (( _Wind_Density * _TimeParameters.y )).xxxx;
				float4 temp_cast_3 = (0.0).xxxx;
				float4 lerpResult1328 = lerp( ( ( ( tex2Dlod( _Wind_Noise_Texture, float4( texCoord1319, 0, 0.0) ) - temp_cast_2 ) * _Wind_Strength ) + float4( 0,0,0,0 ) ) , temp_cast_3 , inputMesh.ase_color);
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 texCoord1622 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float3 normalizeResult4_g20 = normalize( ( V + SafeNormalize(-_DirectionalLightDatas[0].forward) ) );
				...
				float dotResult504 = dot( normalizeResult4_g20 , normalizeResult499 );
				...
				float2 texCoord626 = packedInput.ase_texcoord1.xy * temp_cast_4 + float2( 0,0 );
				...
				float localStochasticTiling53_g19 = ( 0.0 );
				float2 temp_cast_7 = (_InkGrunge_Tiling).xx;
				float2 temp_output_104_0_g19 = temp_cast_7;
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float3 temp_output_80_0_g19 = ase_worldPos;
				float2 Triplanar_UV050_g19 = ( temp_output_104_0_g19 * (temp_output_80_0_g19).zy );
				float2 UV53_g19 = Triplanar_UV050_g19;
				float2 UV153_g19 = float2( 0,0 );
				float2 UV253_g19 = float2( 0,0 );
				float2 UV353_g19 = float2( 0,0 );
				float W153_g19 = 0.0;
				float W253_g19 = 0.0;
				float W353_g19 = 0.0;
				StochasticTiling( UV53_g19 , UV153_g19 , UV253_g19 , UV353_g19 , W153_g19 , W253_g19 , W353_g19 );
				float2 temp_output_57_0_g19 = ddx( Triplanar_UV050_g19 );
				float2 temp_output_58_0_g19 = ddy( Triplanar_UV050_g19 );
				float localTriplanarWeights108_g19 = ( 0.0 );
				float3 WorldNormal108_g19 = ase_worldNormal;
				float W0108_g19 = 0.0;
				float W1108_g19 = 0.0;
				float W2108_g19 = 0.0;
				TriplanarWeights108_g19( WorldNormal108_g19 , W0108_g19 , W1108_g19 , W2108_g19 );
				float localStochasticTiling83_g19 = ( 0.0 );
				float2 Triplanar_UV164_g19 = ( temp_output_104_0_g19 * (temp_output_80_0_g19).zx );
				float2 UV83_g19 = Triplanar_UV164_g19;
				float2 UV183_g19 = float2( 0,0 );
				float2 UV283_g19 = float2( 0,0 );
				float2 UV383_g19 = float2( 0,0 );
				float W183_g19 = 0.0;
				float W283_g19 = 0.0;
				float W383_g19 = 0.0;
				StochasticTiling( UV83_g19 , UV183_g19 , UV283_g19 , UV383_g19 , W183_g19 , W283_g19 , W383_g19 );
				float2 temp_output_86_0_g19 = ddx( Triplanar_UV164_g19 );
				float2 temp_output_92_0_g19 = ddy( Triplanar_UV164_g19 );
				float localStochasticTiling117_g19 = ( 0.0 );
				float2 Triplanar_UV271_g19 = ( temp_output_104_0_g19 * (temp_output_80_0_g19).xy );
				float2 UV117_g19 = Triplanar_UV271_g19;
				float2 UV1117_g19 = float2( 0,0 );
				float2 UV2117_g19 = float2( 0,0 );
				float2 UV3117_g19 = float2( 0,0 );
				float W1117_g19 = 0.0;
				float W2117_g19 = 0.0;
				float W3117_g19 = 0.0;
				StochasticTiling( UV117_g19 , UV1117_g19 , UV2117_g19 , UV3117_g19 , W1117_g19 , W2117_g19 , W3117_g19 );
				float2 temp_output_107_0_g19 = ddx( Triplanar_UV271_g19 );
				float2 temp_output_110_0_g19 = ddy( Triplanar_UV271_g19 );
				float4 Output_Triplanar295_g19 = ( ( ( ( tex2D( _InkGrunge_Texture, UV153_g19, temp_output_57_0_g19, temp_output_58_0_g19 ) * W153_g19 ) + ( tex2D( _InkGrunge_Texture, UV253_g19, temp_output_57_0_g19, temp_output_58_0_g19 ) * W253_g19 ) + ( tex2D( _InkGrunge_Texture, UV353_g19, temp_output_57_0_g19, temp_output_58_0_g19 ) * W353_g19 ) ) * W0108_g19 ) + ( W1108_g19 * ( ( tex2D( _InkGrunge_Texture, UV183_g19, temp_output_86_0_g19, temp_output_92_0_g19 ) * W183_g19 ) + ( tex2D( _InkGrunge_Texture, UV283_g19, temp_output_86_0_g19, temp_output_92_0_g19 ) * W283_g19 ) + ( tex2D( _InkGrunge_Texture, UV383_g19, temp_output_86_0_g19, temp_output_92_0_g19 ) * W383_g19 ) ) ) + ( W2108_g19 * ( ( tex2D( _InkGrunge_Texture, UV1117_g19, temp_output_107_0_g19, temp_output_110_0_g19 ) * W1117_g19 ) + ( tex2D( _InkGrunge_Texture, UV2117_g19, temp_output_107_0_g19, temp_output_110_0_g19 ) * W2117_g19 ) + ( tex2D( _InkGrunge_Texture, UV3117_g19, temp_output_107_0_g19, temp_output_110_0_g19 ) * W3117_g19 ) ) ) );
				...
				float4 blendOpSrc461 = ( ( ( grayscale455 + _PaperContrast ) * _PaperMultiply ) * ( CalculateContrast(_InkGrunge_Contrast,Output_Triplanar295_g19) * _InkGrunge_Multiply ).r );
				...
				float2 texCoord1373 = packedInput.ase_texcoord1.xy * temp_cast_10 + float2( 0,0 );
				...
				float2 texCoord1556 = packedInput.ase_texcoord1.xy * temp_cast_18 + _TopTex_NoiseOffset;
				...
				float dotResult12 = dot( worldNormal10 , SafeNormalize(-_DirectionalLightDatas[0].forward) );
				float normal_LightDir23 = ( dotResult12 * 1 );
				float smoothstepResult385 = smoothstep( _StepShadow , temp_output_387_0 , normal_LightDir23);
				float2 temp_cast_22 = (_Noise_Tiling).xx;
				float2 texCoord565 = packedInput.ase_texcoord1.xy * temp_cast_22 + float2( 0,0 );
				...
				float dotResult1283 = dot( V , -( SafeNormalize(-_DirectionalLightDatas[0].forward) + ( worldNormal1286 * _SSS_Distortion ) ) );
				...
				float2 texCoord1053 = packedInput.ase_texcoord1.xy * temp_cast_28 + float2( 0,0 );
				...
				float4 _InBrumeTextureArray_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(EnvironmentObjectsShader,_InBrumeTextureArray_ST);
				float2 uv_InBrumeTextureArray = packedInput.ase_texcoord1.xy * _InBrumeTextureArray_ST_Instance.xy + _InBrumeTextureArray_ST_Instance.zw;
				...
				float2 texCoord1203 = packedInput.ase_texcoord1.xy * temp_cast_32 + _ShadowDrippingNoise_Offset;
				...
				float2 texCoord1754 = packedInput.ase_texcoord1.xy * temp_cast_37 + float2( 0,0 );
				float2 Input_UV145_g15 = texCoord1754;
				...
				float2 texCoord1755 = packedInput.ase_texcoord1.xy * temp_cast_39 + float2( 0,0 );
				float2 Input_UV145_g21 = texCoord1755;
				...
				float4 Output_2D293_g21 = ( ( tex2D( _InBrumeGrunge_Texture, UV12_g21, temp_output_10_0_g21, temp_output_12_0_g21 ) * W12_g21 ) + ( tex2D( _InBrumeGrunge_Texture, UV22_g21, temp_output_10_0_g21, temp_output_12_0_g21 ) * W22_g21 ) + ( tex2D( _InBrumeGrunge_Texture, UV32_g21, temp_output_10_0_g21, temp_output_12_0_g21 ) * W32_g21 ) );
				float grayscale1115 = Luminance(CalculateContrast(_NormalInBrumeGrunge_Contrast,Output_2D293_g21).rgb);
				...
				float2 texCoord1184 = packedInput.ase_texcoord1.xy * temp_cast_43 + _NormalDrippingNoise_Offset;
				...
				surfaceDescription.Color = lerpResult1405.rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = Opacity1375;
		...
		Pass
		{
					...
					)
			{
				...
				float TerrainBlendingMask1761 = clampResult1356.r;
				float clampResult1771 = clamp( ( TerrainBlendingMask1761 + _TerrainBlending_Opacity ) , 0.0 , 1.0 );
				float2 texCoord1622 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 TextureCoordinates1629 = texCoord1622;
				float4 tex2DArrayNode1711 = SAMPLE_TEXTURE2D_ARRAY( _ObjectTextureArray, sampler_ObjectTextureArray, TextureCoordinates1629,0.0 );
				float Object_Opacity_Texture1457 = tex2DArrayNode1711.a;
				float Object_CustomOpacityMask_Texture1475 = SAMPLE_TEXTURE2D_ARRAY( _ObjectTextureArray, sampler_ObjectTextureArray, TextureCoordinates1629,4.0 ).r;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord1622 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 TextureCoordinates1629 = texCoord1622;
				float4 Object_Roughness_Texture1455 = SAMPLE_TEXTURE2D_ARRAY( _ObjectTextureArray, sampler_ObjectTextureArray, TextureCoordinates1629,2.0 );
				float4 temp_output_522_0 = ( ( 1.0 - Object_Roughness_Texture1455 ) * _Roughness_Multiplier );
				float4 temp_cast_1 = (0.0).xxxx;
				...
				float3 normalizeResult4_g20 = normalize( ( ase_worldViewDir + SafeNormalize(-_DirectionalLightDatas[0].forward) ) );
				float4 Object_Normal_Texture1454 = SAMPLE_TEXTURE2D_ARRAY( _ObjectTextureArray, sampler_ObjectTextureArray, TextureCoordinates1629,1.0 );
				float3 ase_worldTangent = packedInput.ase_texcoord2.xyz;
				float3 ase_worldNormal = packedInput.ase_texcoord3.xyz;
				float3 ase_worldBitangent = packedInput.ase_texcoord4.xyz;
				...
				float4 temp_cast_3 = (smoothstepResult632).xxxx;
				float2 temp_cast_4 = (_SpecularNoise).xx;
				float2 texCoord626 = packedInput.ase_texcoord.xy * temp_cast_4 + float2( 0,0 );
				float grayscale634 = Luminance(step( ( temp_cast_3 - SAMPLE_TEXTURE2D_ARRAY( _NoiseandGrungeOutBrumeTextureArray, sampler_NoiseandGrungeOutBrumeTextureArray, texCoord626,1.0 ) ) , float4( 0,0,0,0 ) ).rgb);
				float4 lerpResult1401 = lerp( temp_cast_1 , ( (0.0 + (grayscale634 - 0.0) * (1.0 - 0.0) / (1.0 - 0.0)) * _SpecularColor ) , _Specular);
				float4 RoughnessNormal1585 = ( float4( (temp_output_522_0).rgb , 0.0 ) * (temp_output_522_0).a * lerpResult1401 );
				float4 screenPos = packedInput.ase_texcoord5;
				...
				float4 RGB1366 = ( saturate( ( blendOpSrc461 * blendOpDest461 ) ));
				float2 temp_cast_10 = (_TerrainBlending_TextureTiling).xx;
				float2 texCoord1373 = packedInput.ase_texcoord.xy * temp_cast_10 + float2( 0,0 );
				float worldY1344 = ase_worldPos.y;
				float4 temp_cast_11 = (worldY1344).xxxx;
				float2 appendResult1340 = (float2(ase_worldPos.x , ase_worldPos.z));
				float2 appendResult1339 = (float2(TB_OFFSET_X , TB_OFFSET_Z));
				...
				float smoothstepResult1559 = smoothstep( _TopTex_Step , ( _TopTex_Step + _TopTex_Smoothstep ) , dotResult1557);
				float2 temp_cast_18 = (_TopTex_NoiseTiling).xx;
				float2 texCoord1556 = packedInput.ase_texcoord.xy * temp_cast_18 + _TopTex_NoiseOffset;
				float4 tex2DNode1582 = tex2D( _TopTex_Noise_Texture, texCoord1556 );
				float smoothstepResult1563 = smoothstep( 0.0 , 0.25 , ( smoothstepResult1559 - tex2DNode1582.r ));
				float _TopTex_NoiseHoles_Instance = UNITY_ACCESS_INSTANCED_PROP(EnvironmentObjectsShader,_TopTex_NoiseHoles);
				float lerpResult1595 = lerp( 0.0 , step( tex2DNode1582.r , 0.34 ) , _TopTex_NoiseHoles_Instance);
				...
				float smoothstepResult385 = smoothstep( _StepShadow , temp_output_387_0 , normal_LightDir23);
				float2 temp_cast_22 = (_Noise_Tiling).xx;
				float2 texCoord565 = packedInput.ase_texcoord.xy * temp_cast_22 + float2( 0,0 );
				float2 lerpResult1413 = lerp( texCoord565 , ( (ase_screenPosNorm).xy * _Noise_Tiling ) , _ScreenBasedNoise);
				float2 panner571 = ( 1.0 * _Time.y * ( _Noise_Panner + float2( 0.1,0.05 ) ) + lerpResult1413);
				float2 panner484 = ( 1.0 * _Time.y * _Noise_Panner + lerpResult1413);
				float blendOpSrc570 = SAMPLE_TEXTURE2D_ARRAY( _NoiseandGrungeOutBrumeTextureArray, sampler_NoiseandGrungeOutBrumeTextureArray, ( panner571 + float2( 0.5,0.5 ) ),1.0 ).r;
				...
				float3 tanNormal1286 = Object_Normal_Texture1454.rgb;
				float3 worldNormal1286 = float3(dot(tanToWorld0,tanNormal1286), dot(tanToWorld1,tanNormal1286), dot(tanToWorld2,tanNormal1286));
				float dotResult1283 = dot( ase_worldViewDir , -( SafeNormalize(-_DirectionalLightDatas[0].forward) + ( worldNormal1286 * _SSS_Distortion ) ) );
				float dotResult1293 = dot( dotResult1283 , _SSS_Scale );
				float saferPower1296 = max( dotResult1293 , 0.0001 );
				float4 SSS1275 = ( _SSS_Color * saturate( pow( saferPower1296 , _SSS_Power ) ) );
				float4 blendOpSrc1290 = temp_output_518_0;
				...
				float4 temp_cast_27 = (1.0).xxxx;
				float2 temp_cast_28 = (_InkSplatter_Tiling).xx;
				float2 texCoord1053 = packedInput.ase_texcoord.xy * temp_cast_28 + float2( 0,0 );
				float4 temp_cast_29 = (0.5).xxxx;
				float4 temp_output_1058_0 = step( SAMPLE_TEXTURE2D_ARRAY( _InBrumeTextureArray, sampler_InBrumeTextureArray, texCoord1053,0.0 ) , temp_cast_29 );
				float4 temp_cast_30 = (0.5).xxxx;
				float4 _InBrumeTextureArray_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(EnvironmentObjectsShader,_InBrumeTextureArray_ST);
				float2 uv_InBrumeTextureArray = packedInput.ase_texcoord.xy * _InBrumeTextureArray_ST_Instance.xy + _InBrumeTextureArray_ST_Instance.zw;
				float4 lerpResult1418 = lerp( temp_cast_27 , ( ( 1.0 - temp_output_1058_0 ) + ( temp_output_1058_0 * SAMPLE_TEXTURE2D_ARRAY( _InBrumeTextureArray, sampler_InBrumeTextureArray, uv_InBrumeTextureArray,1.0 ) ) ) , _InkSplatter);
				float4 InkSplatter1244 = lerpResult1418;
				float smoothstepResult1227 = smoothstep( ( _ShadowDrippingNoise_Smoothstep + _ShadowDrippingNoise_Step ) , _ShadowDrippingNoise_Step , normal_LightDir23);
				float4 temp_cast_31 = (smoothstepResult1227).xxxx;
				float2 temp_cast_32 = (_DrippingNoise_Tiling).xx;
				float2 texCoord1203 = packedInput.ase_texcoord.xy * temp_cast_32 + _ShadowDrippingNoise_Offset;
				float4 temp_output_1228_0 = ( temp_cast_31 - SAMPLE_TEXTURE2D_ARRAY( _InBrumeTextureArray, sampler_InBrumeTextureArray, texCoord1203,1.0 ) );
				float4 temp_cast_33 = (step( normal_LightDir23 , _ShadowDrippingNoise_Step )).xxxx;
				float4 blendOpSrc1231 = temp_output_1228_0;
				float4 blendOpDest1231 = temp_cast_33;
				...
				float localStochasticTiling2_g15 = ( 0.0 );
				float2 temp_cast_37 = (_ShadowInBrumeGrunge_Tiling).xx;
				float2 texCoord1754 = packedInput.ase_texcoord.xy * temp_cast_37 + float2( 0,0 );
				float2 Input_UV145_g15 = texCoord1754;
				float2 UV2_g15 = Input_UV145_g15;
				float2 UV12_g15 = float2( 0,0 );
				float2 UV22_g15 = float2( 0,0 );
				...
				float localStochasticTiling2_g21 = ( 0.0 );
				float2 temp_cast_39 = (_NormalInBrumeGrunge_Tiling).xx;
				float2 texCoord1755 = packedInput.ase_texcoord.xy * temp_cast_39 + float2( 0,0 );
				float2 Input_UV145_g21 = texCoord1755;
				float2 UV2_g21 = Input_UV145_g21;
				float2 UV12_g21 = float2( 0,0 );
				float2 UV22_g21 = float2( 0,0 );
				...
				float4 temp_cast_42 = (( 1.0 - smoothstepResult1179 )).xxxx;
				float2 temp_cast_43 = (_NormalDrippingNoise_Tiling).xx;
				float2 texCoord1184 = packedInput.ase_texcoord.xy * temp_cast_43 + _NormalDrippingNoise_Offset;
				float4 temp_output_1186_0 = ( temp_output_1106_0 + ( temp_cast_42 - SAMPLE_TEXTURE2D_ARRAY( _InBrumeTextureArray, sampler_InBrumeTextureArray, texCoord1184,1.0 ) ) );
				float4 temp_cast_44 = (( 1.0 - smoothstepResult1179 )).xxxx;
				float4 blendOpSrc1189 = ( NormalInBrumeGrunge1247 * temp_output_1186_0 );
				float4 blendOpDest1189 = ( 1.0 - temp_output_1186_0 );
		...
		Pass
		{
			...
			VertexInput ApplyMeshModification(VertexInput inputMesh, float3 timeParameters, inout VertexOutput o )
			{
				...
				o.ase_texcoord5.xy = inputMesh.ase_texcoord.xy;
					...
					)
			{
				...
				float TerrainBlendingMask1761 = clampResult1356.r;
				float clampResult1771 = clamp( ( TerrainBlendingMask1761 + _TerrainBlending_Opacity ) , 0.0 , 1.0 );
				float2 texCoord1622 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 TextureCoordinates1629 = texCoord1622;
				float4 tex2DArrayNode1711 = SAMPLE_TEXTURE2D_ARRAY( _ObjectTextureArray, sampler_ObjectTextureArray, TextureCoordinates1629,0.0 );
				float Object_Opacity_Texture1457 = tex2DArrayNode1711.a;
				float Object_CustomOpacityMask_Texture1475 = SAMPLE_TEXTURE2D_ARRAY( _ObjectTextureArray, sampler_ObjectTextureArray, TextureCoordinates1629,4.0 ).r;
...
/*ASEBEGIN
Version=18707
0;0;1920;1019;-2297.453;5887.414;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;1363;-5214.471,1562.834;Inherit;False;Property;_TerrainBlending_BlendThickness;TerrainBlending_BlendThickness;17;0;Create;True;0;0;False;0;False;0;2;0;30;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1526;-607.0931,-5081.576;Inherit;False;Property;_DepthFade_Dither_Tiling;DepthFade_Dither_Tiling;96;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1316;-3404.272,-5841.589;Inherit;False;Property;_Wind_Texture_Tiling;Wind_Texture_Tiling;86;0;Create;True;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;1531;-470.9058,-5460.349;Inherit;True;Property;_DepthFade_Dither_Texture;DepthFade_Dither_Texture;95;0;Create;True;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;1543;-151.3415,-4968.07;Inherit;False;Property;_DepthFade_Texture;DepthFade_Texture?;94;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1711;-6678.491,-6022.488;Inherit;True;Property;_ObjectTextureArray;Object Texture Array;11;0;Create;True;0;0;False;0;False;-1;None;b6b5d9dc92e335d44a8ce9459051a78d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1528;263.4483,-5101.56;Inherit;False;Property;_DepthFade_DitherMultiply;DepthFade_DitherMultiply;97;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;1550;-533.4002,-5741.352;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1551;-614.8028,-5651.579;Inherit;False;Property;_InverseCustomOpacityMask;InverseCustomOpacityMask?;10;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1324;-2212.674,-5784.213;Inherit;False;Property;_Wind_Strength;Wind_Strength;89;0;Create;True;0;0;False;0;False;2;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1532;265.3683,-5379.096;Inherit;False;Property;_DepthFade_Falloff;DepthFade_Falloff;98;0;Create;True;0;0;False;0;False;3;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1546;540.1972,-5055.07;Inherit;False;Property;_DepthFade_ClampMin;DepthFade_ClampMin;100;0;Create;True;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1533;258.3684,-5297.096;Inherit;False;Property;_DepthFade_Distance;DepthFade_Distance;99;0;Create;True;0;0;False;0;False;10.5;10.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1535;539.9333,-4970.578;Inherit;False;Property;_DepthFade_ClampMax;DepthFade_ClampMax;101;0;Create;True;0;0;False;0;False;0.8;0.8;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1538;1212.094,-5638.521;Inherit;False;Property;_DepthFade;DepthFade?;93;0;Create;True;0;0;False;1;Header(Depth Fade);False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;845;2251.206,-6096.439;Inherit;False;1531.766;1053.436;FinalPass;18;1407;1334;1408;1331;1405;1406;1404;1403;582;954;474;844;955;1376;1464;1609;1611;1792;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1750;1687.731,-2577.955;Inherit;False;Property;_ShadowInBrumeGrunge_Tiling;ShadowInBrumeGrunge_Tiling;78;0;Create;True;0;0;False;0;False;0.2;6;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1108;2065.354,-1860.845;Inherit;False;Property;_NormalDrippingNoise_Step;NormalDrippingNoise_Step;74;0;Create;True;0;0;False;0;False;0.45;0.461;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1419;3005.513,-4334.397;Inherit;False;Property;_InkSplatter;InkSplatter?;66;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1385;-5467.227,-3049.474;Inherit;False;Property;_InkGrunge_Tiling;InkGrunge_Tiling;30;0;Create;True;0;0;False;0;False;1;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1272;-4317.865,29.92182;Inherit;False;Property;_SSS_Color;SSS_Color;56;0;Create;True;0;0;False;0;False;1,0,0,0;1,0.009498575,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1594;-662.7923,-2484.48;Inherit;False;InstancedProperty;_TopTex_NoiseHoles;TopTex_NoiseHoles?;49;0;Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1230;1725.979,-3525.107;Inherit;False;Property;_ShadowDrippingNoise_Smoothstep;ShadowDrippingNoise_Smoothstep;69;0;Create;True;0;0;False;0;False;0.2;0.003;0.001;0.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;1194;1617.961,-3168.183;Inherit;False;Property;_ShadowDrippingNoise_Offset;ShadowDrippingNoise_Offset;72;0;Create;True;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;1374;-5386.789,823.0943;Inherit;False;Property;_TerrainBlending_TextureTiling;TerrainBlending_TextureTiling;16;0;Create;True;0;0;False;0;False;1;0.55;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;1193;2316.136,-1453.259;Inherit;False;Property;_NormalDrippingNoise_Offset;NormalDrippingNoise_Offset;76;0;Create;True;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;1221;3665.805,-3718.18;Inherit;False;Property;_ShadowDrippingNoise_Transition;ShadowDrippingNoise_Transition;68;0;Create;True;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1191;2322.838,-1540.714;Inherit;False;Property;_NormalDrippingNoise_Tiling;NormalDrippingNoise_Tiling;75;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1182;2046.222,-1760.473;Inherit;False;Property;_NormalDrippingNoise_Smoothstep;NormalDrippingNoise_Smoothstep;73;0;Create;True;0;0;False;0;False;0.01;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1760;-4549.126,932.0366;Inherit;False;Property;_TerrainBlending_Color;TerrainBlending_Color;14;0;Create;True;0;0;False;0;False;1,1,1,0;0.3679245,0.2556302,0.2412335,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1054;1593.358,-4525.176;Inherit;False;Property;_InkSplatter_Tiling;InkSplatter_Tiling;67;0;Create;True;0;0;False;0;False;1;3.93;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1751;1712.557,-2305.803;Inherit;False;Property;_NormalInBrumeGrunge_Tiling;NormalInBrumeGrunge_Tiling;81;0;Create;True;0;0;False;0;False;0.2;6;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;1104;1597.38,-2491.586;Inherit;True;Property;_InBrumeGrunge_Texture;NormalInBrumeGrunge_Texture;80;0;Create;False;0;0;False;0;False;88d75bbfdb8a26849988713b4599646a;88d75bbfdb8a26849988713b4599646a;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.ColorNode;450;-5064.992,-1301.37;Inherit;False;Property;_ShadowColor;ShadowColor;38;0;Create;True;0;0;False;0;False;0.8018868,0.8018868,0.8018868,0;0.5,0.5,0.5,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;1752;2260.557,-2489.803;Inherit;False;Procedural Sample;-1;;21;f5379ff72769e2b4495e5ce2f004d8d4;2,157,0,315,0;7;82;SAMPLER2D;0;False;158;SAMPLER2DARRAY;0;False;183;FLOAT;0;False;5;FLOAT2;0,0;False;80;FLOAT3;0,0,0;False;104;FLOAT2;1,0;False;74;SAMPLERSTATE;0;False;5;COLOR;0;FLOAT;32;FLOAT;33;FLOAT;34;FLOAT;35
Node;AmplifyShaderEditor.TexturePropertyNode;1195;1589.404,-2777.549;Inherit;True;Property;_InBrumeGrunge_Texture2;ShadowInBrumeGrunge_Texture;77;0;Create;False;0;0;False;0;False;88d75bbfdb8a26849988713b4599646a;88d75bbfdb8a26849988713b4599646a;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.ColorNode;1256;6362.291,-3414.715;Inherit;False;Property;_InBrumeColorCorrection;InBrumeColorCorrection;83;0;Create;True;0;0;False;0;False;1,1,1,0;0.8773585,0.8773585,0.8773585,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;1520;2250.888,-4183.003;Inherit;True;Property;_TextureSample24;Texture Sample 24;63;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;1503;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1114;2567.943,-2393.435;Inherit;False;Property;_NormalInBrumeGrunge_Contrast;NormalInBrumeGrunge_Contrast;82;0;Create;True;0;0;False;0;False;2.4;-6.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1117;2587.215,-2674.273;Inherit;False;Property;_ShadowInBrumeGrunge_Contrast;ShadowInBrumeGrunge_Contrast;79;0;Create;True;0;0;False;0;False;-3.38;-20;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1382;-5105.739,-3303.506;Inherit;False;Procedural Sample;-1;;19;f5379ff72769e2b4495e5ce2f004d8d4;2,157,2,315,2;7;82;SAMPLER2D;0;False;158;SAMPLER2DARRAY;0;False;183;FLOAT;0;False;5;FLOAT2;0,0;False;80;FLOAT3;0,0,0;False;104;FLOAT2;1,0;False;74;SAMPLERSTATE;0;False;5;COLOR;0;FLOAT;32;FLOAT;33;FLOAT;34;FLOAT;35
...
Node;AmplifyShaderEditor.SamplerNode;1491;-5347.481,-3939.872;Inherit;True;Property;_TextureSample12;Texture Sample 12;21;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;1482;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1566;-1448.42,-3042.376;Inherit;False;Property;_TopTex_Step;TopTex_Step;52;0;Create;True;0;0;False;0;False;0;0.6;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1567;-1495.419,-2934.377;Inherit;False;Property;_TopTex_Smoothstep;TopTex_Smoothstep;53;0;Create;True;0;0;False;0;False;0.3;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1164;1623.455,-3256.258;Inherit;False;Property;_DrippingNoise_Tiling;ShadowDrippingNoise_Tiling;71;0;Create;False;0;0;False;0;False;1;-5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1165;1732.137,-3438.533;Inherit;False;Property;_ShadowDrippingNoise_Step;ShadowDrippingNoise_Step;70;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;500;-6256.754,-790.8345;Inherit;False;Blinn-Phong Half Vector;-1;;20;91a149ac9d615be429126c95e20753ce;0;0;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;458;-4740.422,-3844.986;Inherit;False;Property;_PaperContrast;PaperContrast;27;0;Create;True;0;0;False;0;False;0.5660378,0.5660378,0.5660378,0;0.5019608,0.5019608,0.5019608,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1392;-2075.881,-4444.435;Inherit;False;Property;_CustomRimLight_Opacity;CustomRimLight_Opacity;61;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;989;4947.555,-3758.932;Inherit;False;Property;_ColorShadow;ColorShadow;64;0;Create;True;0;0;False;0;False;0.5283019,0.5283019,0.5283019,0;0.1509433,0.1509433,0.1509433,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;1792;0;1405;0
WireConnection;1792;2;1376;0
WireConnection;1792;6;1609;0
ASEEND*/
//CHKSM=6A7D8379B3302C64ECC6C53BFBDFBB351F36694C