	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 texCoord1754 = IN.ase_texcoord3.xy * temp_cast_37 + float2( 0,0 );
				float2 Input_UV145_g22 = texCoord1754;
				...
				float4 Output_2D293_g22 = ( ( tex2D( _InBrumeGrunge_Texture2, UV12_g22, temp_output_10_0_g22, temp_output_12_0_g22 ) * W12_g22 ) + ( tex2D( _InBrumeGrunge_Texture2, UV22_g22, temp_output_10_0_g22, temp_output_12_0_g22 ) * W22_g22 ) + ( tex2D( _InBrumeGrunge_Texture2, UV32_g22, temp_output_10_0_g22, temp_output_12_0_g22 ) * W32_g22 ) );
				float grayscale1119 = Luminance(CalculateContrast(_ShadowInBrumeGrunge_Contrast,Output_2D293_g22).rgb);
				...
				float2 texCoord1755 = IN.ase_texcoord3.xy * temp_cast_39 + float2( 0,0 );
...
/*ASEBEGIN
Version=18707
0;0;1920;1019;1856.268;6994.553;4.016711;True;False
...
Node;AmplifyShaderEditor.TexturePropertyNode;1320;-3121.824,-6050.601;Inherit;True;Property;_Wind_Noise_Texture;Wind_Noise_Texture;85;0;Create;True;0;0;False;0;False;1cb5d7a8b79999d4b8356e740bbf6667;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.ColorNode;1760;-4549.126,932.0366;Inherit;False;Property;_TerrainBlending_Color;TerrainBlending_Color;14;0;Create;True;0;0;False;0;False;1,1,1,0;0.3679244,0.2556301,0.2412334,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;1749;2262.531,-2775.654;Inherit;False;Procedural Sample;-1;;22;f5379ff72769e2b4495e5ce2f004d8d4;2,157,0,315,0;7;82;SAMPLER2D;0;False;158;SAMPLER2DARRAY;0;False;183;FLOAT;0;False;5;FLOAT2;0,0;False;80;FLOAT3;0,0,0;False;104;FLOAT2;1,0;False;74;SAMPLERSTATE;0;False;5;COLOR;0;FLOAT;32;FLOAT;33;FLOAT;34;FLOAT;35
...
ASEEND*/
//CHKSM=9066D149379884C5365D881BE73067F503A9A7BF