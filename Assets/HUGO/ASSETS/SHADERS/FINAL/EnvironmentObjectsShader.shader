...
Shader "EnvironmentObjectsShader"
{
	Properties
	{
		...
		_TextureSample2("Texture Sample 2", 2DArray) = "white" {}
		...
		_ObjectTextureAtlas("Object Texture Atlas", 2D) = "white" {}
	...
	SubShader
	{
		...
		uniform sampler2D _ObjectTextureAtlas;
		...
		UNITY_DECLARE_TEX2DARRAY_NOSAMPLER(_TextureSample2);
...
#define _TopTex_NoiseHoles_arr EnvironmentObjectsShader
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float ObjectTextureAtlas_Columns1625 = 5.0;
			float temp_output_4_0_g16 = ObjectTextureAtlas_Columns1625;
			float ObjectTextureAtlas_Rows1626 = 1.0;
			float temp_output_5_0_g16 = ObjectTextureAtlas_Rows1626;
			float2 appendResult7_g16 = (float2(temp_output_4_0_g16 , temp_output_5_0_g16));
			float totalFrames39_g16 = ( temp_output_4_0_g16 * temp_output_5_0_g16 );
			float2 appendResult8_g16 = (float2(totalFrames39_g16 , temp_output_5_0_g16));
			float clampResult42_g16 = clamp( 0.0 , 0.0001 , ( totalFrames39_g16 - 1.0 ) );
			float temp_output_35_0_g16 = frac( ( ( 0.0 + clampResult42_g16 ) / totalFrames39_g16 ) );
			float2 appendResult29_g16 = (float2(temp_output_35_0_g16 , ( 1.0 - temp_output_35_0_g16 )));
			float2 temp_output_15_0_g16 = ( ( TextureCoordinates1629 / appendResult7_g16 ) + ( floor( ( appendResult8_g16 * appendResult29_g16 ) ) / appendResult7_g16 ) );
			float4 tex2DNode1665 = tex2D( _ObjectTextureAtlas, temp_output_15_0_g16 );
			float Object_Opacity_Texture1457 = tex2DNode1665.a;
			float temp_output_4_0_g15 = ObjectTextureAtlas_Columns1625;
			float temp_output_5_0_g15 = ObjectTextureAtlas_Rows1626;
			...
			float temp_output_35_0_g15 = frac( ( ( 4.0 + clampResult42_g15 ) / totalFrames39_g15 ) );
			float2 appendResult29_g15 = (float2(temp_output_35_0_g15 , ( 1.0 - temp_output_35_0_g15 )));
			float2 temp_output_15_0_g15 = ( ( TextureCoordinates1629 / appendResult7_g15 ) + ( floor( ( appendResult8_g15 * appendResult29_g15 ) ) / appendResult7_g15 ) );
			float Object_CustomOpacityMask_Texture1475 = tex2D( _ObjectTextureAtlas, temp_output_15_0_g15 ).r;
			...
			float2 Input_UV145_g17 = ( (ase_screenPosNorm).xy * _DepthFade_Dither_Tiling );
			...
			float4 Output_2D293_g17 = ( ( tex2D( _DepthFade_Dither_Texture, UV12_g17, temp_output_10_0_g17, temp_output_12_0_g17 ) * W12_g17 ) + ( tex2D( _DepthFade_Dither_Texture, UV22_g17, temp_output_10_0_g17, temp_output_12_0_g17 ) * W22_g17 ) + ( tex2D( _DepthFade_Dither_Texture, UV32_g17, temp_output_10_0_g17, temp_output_12_0_g17 ) * W32_g17 ) );
			float4 break31_g17 = Output_2D293_g17;
			float lerpResult1542 = lerp( 0.0 , break31_g17.r , _DepthFade_Texture);
			...
			float temp_output_4_0_g13 = ObjectTextureAtlas_Columns1625;
			float temp_output_5_0_g13 = ObjectTextureAtlas_Rows1626;
			...
			float temp_output_35_0_g13 = frac( ( ( 2.0 + clampResult42_g13 ) / totalFrames39_g13 ) );
			float2 appendResult29_g13 = (float2(temp_output_35_0_g13 , ( 1.0 - temp_output_35_0_g13 )));
			float2 temp_output_15_0_g13 = ( ( TextureCoordinates1629 / appendResult7_g13 ) + ( floor( ( appendResult8_g13 * appendResult29_g13 ) ) / appendResult7_g13 ) );
			float4 Object_Roughness_Texture1455 = tex2D( _ObjectTextureAtlas, temp_output_15_0_g13 );
			...
			float temp_output_4_0_g3 = ObjectTextureAtlas_Columns1625;
			float temp_output_5_0_g3 = ObjectTextureAtlas_Rows1626;
			...
			float temp_output_35_0_g3 = frac( ( ( 1.0 + clampResult42_g3 ) / totalFrames39_g3 ) );
			float2 appendResult29_g3 = (float2(temp_output_35_0_g3 , ( 1.0 - temp_output_35_0_g3 )));
			float2 temp_output_15_0_g3 = ( ( TextureCoordinates1629 / appendResult7_g3 ) + ( floor( ( appendResult8_g3 * appendResult29_g3 ) ) / appendResult7_g3 ) );
			float4 Object_Normal_Texture1454 = tex2D( _ObjectTextureAtlas, temp_output_15_0_g3 );
			...
			float4 tex2DArrayNode1431 = SAMPLE_TEXTURE2D_ARRAY( _TextureSample2, sampler_TextureSample2, float3(i.uv_texcoord,0.0) );
			...
			float temp_output_4_0_g14 = ObjectTextureAtlas_Columns1625;
			float temp_output_5_0_g14 = ObjectTextureAtlas_Rows1626;
			...
			float temp_output_35_0_g14 = frac( ( ( 3.0 + clampResult42_g14 ) / totalFrames39_g14 ) );
			float2 appendResult29_g14 = (float2(temp_output_35_0_g14 , ( 1.0 - temp_output_35_0_g14 )));
			float2 temp_output_15_0_g14 = ( ( TextureCoordinates1629 / appendResult7_g14 ) + ( floor( ( appendResult8_g14 * appendResult29_g14 ) ) / appendResult7_g14 ) );
			float4 Object_RimLightMask_Texture1456 = tex2D( _ObjectTextureAtlas, temp_output_15_0_g14 );
...
/*ASEBEGIN
Version=18707
0;0;1920;1019;11341.86;8963.348;5.928485;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;1620;-7442.896,-7799.561;Inherit;False;Constant;_Lignes;Lignes;1;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1619;-7446.896,-7871.561;Inherit;False;Constant;_Colonnes;Colonnes;1;0;Create;True;0;0;False;0;False;5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;1466;-6877.657,-8047.475;Inherit;False;1326.677;1761.921;Object Texture Atlas;36;1453;1457;1665;1475;1621;1630;1618;1628;1627;1476;1649;1651;1652;1654;1650;1456;1451;1643;1648;1645;1646;1644;1455;1449;1637;1640;1638;1642;1639;1454;1447;1631;1636;1634;1633;1632;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1634;-6777.81,-7361.062;Inherit;False;Constant;_Float12;Float 12;1;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;463;-6642.376,-3707.739;Inherit;False;Property;_Paper_Tiling;Paper_Tiling;21;0;Create;True;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;1447;-6221.95,-7534.908;Inherit;True;Property;_TextureSample10;Texture Sample 10;98;0;Create;True;0;0;False;0;False;-1;d0091e005383fcc4f9fda7c9ef4d7dff;d0091e005383fcc4f9fda7c9ef4d7dff;True;0;False;white;Auto;False;Instance;1665;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;667;-6436.423,-3364.986;Inherit;False;Property;_Paper_Flipbook_Speed;Paper_Flipbook_Speed;24;0;Create;True;0;0;False;0;False;1;6;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;479;-4672.714,-4371.914;Inherit;False;Property;_Noise_Tiling;Noise_Tiling;29;0;Create;True;0;0;False;1;Header(Shadow and NoiseEdge);False;1;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;666;-6436.423,-3444.986;Inherit;False;Property;_Paper_Flipbook_Rows;Paper_Flipbook_Rows;23;0;Create;True;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;665;-6452.423,-3524.986;Inherit;False;Property;_Paper_Flipbook_Columns;Paper_Flipbook_Columns;22;0;Create;True;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1454;-5846.764,-7535.36;Inherit;False;Object_Normal_Texture;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.Vector2Node;487;-3922.708,-4301.77;Inherit;False;Property;_Noise_Panner;Noise_Panner;31;0;Create;True;0;0;False;0;False;0.2,-0.1;0.01,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;1412;-5751.274,-3547.36;Inherit;False;Property;_MovingPaper;MovingPaper?;20;0;Create;True;0;0;False;1;Header(Paper);False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;1361;-5611.448,1973.651;Inherit;False;Property;_TerrainBlendingNoise_Tiling;TerrainBlendingNoise_Tiling;18;0;Create;True;0;0;False;0;False;1,1;0.3,0.3;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SamplerNode;1491;-5346.481,-3939.872;Inherit;True;Property;_TextureSample12;Texture Sample 12;19;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;1482;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;1362;-5666.299,1611.293;Inherit;True;Property;_TerrainBlendingNoise_Texture;TerrainBlendingNoise_Texture;17;0;Create;True;0;0;False;0;False;1cb5d7a8b79999d4b8356e740bbf6667;c5ad016d3a1aba84ea1e7d0364506280;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;1363;-5214.471,1562.834;Inherit;False;Property;_TerrainBlending_BlendThickness;TerrainBlending_BlendThickness;15;0;Create;True;0;0;False;0;False;0;0.3;0;30;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;458;-4740.422,-3844.986;Inherit;False;Property;_PaperContrast;PaperContrast;25;0;Create;True;0;0;False;0;False;0.5660378,0.5660378,0.5660378,0;0.6226414,0.6226414,0.6226414,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;526;-4308.421,-3700.986;Inherit;False;Property;_PaperMultiply;PaperMultiply;26;0;Create;True;0;0;False;0;False;1.58;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;1497;-4655.898,-3393.056;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;1385;-4677.623,-3221.947;Inherit;False;Property;_InkGrunge_Tiling;InkGrunge_Tiling;28;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;1569;-2107.549,-2357.57;Inherit;False;Property;_TopTex_NoiseOffset;TopTex_NoiseOffset;47;0;Create;True;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;1568;-2105.715,-2442.564;Inherit;False;Property;_TopTex_NoiseTiling;TopTex_NoiseTiling;46;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;1495;-3063.946,-4667.642;Inherit;True;Property;_TextureSample14;Texture Sample 14;19;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;1482;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;839;-4699.783,-3599.956;Inherit;True;Property;_InkGrunge_Texture;InkGrunge_Texture;27;0;Create;True;0;0;False;1;Header(Ink Grunge);False;88d75bbfdb8a26849988713b4599646a;88d75bbfdb8a26849988713b4599646a;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;1567;-1478.943,-2781.978;Inherit;False;Property;_TopTex_Smoothstep;TopTex_Smoothstep;49;0;Create;True;0;0;False;0;False;0.3;0.4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1493;-3065.946,-4401.642;Inherit;True;Property;_TextureSample13;Texture Sample 13;19;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;1482;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1566;-1431.944,-2889.977;Inherit;False;Property;_TopTex_Step;TopTex_Step;48;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;388;-6440.995,-1877.37;Inherit;False;Property;_StepAttenuation;StepAttenuation;33;0;Create;True;0;0;False;0;False;0.3;-0.07;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;386;-6807.995,-1595.37;Inherit;False;Property;_StepShadow;StepShadow;32;0;Create;True;0;0;False;0;False;0.03;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;1194;1596.004,-3179.162;Inherit;False;Property;_ShadowDrippingNoise_Offset;ShadowDrippingNoise_Offset;68;0;Create;True;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;627;-6101.063,-336.7776;Inherit;False;Property;_SpecularNoise;SpecularNoise;38;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1230;1704.022,-3536.086;Inherit;False;Property;_ShadowDrippingNoise_Smoothstep;ShadowDrippingNoise_Smoothstep;65;0;Create;True;0;0;False;0;False;0.2;0.001;0.001;0.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1165;1710.18,-3449.512;Inherit;False;Property;_ShadowDrippingNoise_Step;ShadowDrippingNoise_Step;66;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1164;1601.498,-3267.237;Inherit;False;Property;_DrippingNoise_Tiling;ShadowDrippingNoise_Tiling;67;0;Create;False;0;0;False;0;False;1;-5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1374;-4477.458,831.8547;Inherit;False;Property;_TerrainBlending_TextureTiling;TerrainBlending_TextureTiling;14;0;Create;True;0;0;False;0;False;1;-0.37;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;633;-5970.244,-893.9705;Inherit;False;Property;_SpecularStepMax;SpecularStepMax;37;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1594;-646.3167,-2332.081;Inherit;False;InstancedProperty;_TopTex_NoiseHoles;TopTex_NoiseHoles?;45;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1640;-6785.76,-7047.88;Inherit;False;Constant;_Float13;Float 13;1;0;Create;True;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;619;-5970.244,-973.9715;Inherit;False;Property;_SpeculartStepMin;SpeculartStepMin;36;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;1600;-923.715,-3638.455;Inherit;True;Property;_TopTex_Albedo_Texture;TopTex_ Albedo_Texture;42;0;Create;True;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.FunctionNode;1637;-6524.005,-7214.772;Inherit;False;Flipbook;-1;;13;53c2488c220f6564ca6c90721ee16673;2,71,0,68,0;8;51;SAMPLER2D;0.0;False;13;FLOAT2;0,0;False;4;FLOAT;3;False;5;FLOAT;3;False;24;FLOAT;0;False;2;FLOAT;0;False;55;FLOAT;0;False;70;FLOAT;0;False;5;COLOR;53;FLOAT2;0;FLOAT;47;FLOAT;48;FLOAT;62
Node;AmplifyShaderEditor.RangedFloatNode;1264;-6467.678,567.1663;Inherit;False;Property;_SSS_Distortion;SSS_Distortion;51;0;Create;True;0;0;False;0;False;0.8;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1365;-3966.783,783.8404;Inherit;True;Property;_TerrainBlending_TextureTerrain;TerrainBlending_TextureTerrain;13;0;Create;True;0;0;False;0;False;-1;8c8e6bd39f1d3c348a607b675e3dc417;8c8e6bd39f1d3c348a607b675e3dc417;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;1449;-6216.63,-7221.145;Inherit;True;Property;_TextureSample5;Texture Sample 5;98;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;1665;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1054;1571.401,-4536.154;Inherit;False;Property;_InkSplatter_Tiling;InkSplatter_Tiling;63;0;Create;True;0;0;False;0;False;1;3.93;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;450;-5064.992,-1301.37;Inherit;False;Property;_ShadowColor;ShadowColor;34;0;Create;True;0;0;False;0;False;0.8018868,0.8018868,0.8018868,0;0.4056596,0.4056596,0.4056596,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1455;-5846.764,-7222.36;Inherit;False;Object_Roughness_Texture;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1182;2024.265,-1771.452;Inherit;False;Property;_NormalDrippingNoise_Smoothstep;NormalDrippingNoise_Smoothstep;69;0;Create;True;0;0;False;0;False;0.01;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1108;2043.397,-1871.824;Inherit;False;Property;_NormalDrippingNoise_Step;NormalDrippingNoise_Step;70;0;Create;True;0;0;False;0;False;0.45;0.461;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;1104;1575.423,-2502.565;Inherit;True;Property;_InBrumeGrunge_Texture;NormalInBrumeGrunge_Texture;76;0;Create;False;0;0;False;0;False;88d75bbfdb8a26849988713b4599646a;88d75bbfdb8a26849988713b4599646a;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.Vector2Node;1103;1886.511,-2406.857;Inherit;False;Property;_NormalInBrumeGrunge_Tiling;NormalInBrumeGrunge_Tiling;77;0;Create;True;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;1114;2545.985,-2404.414;Inherit;False;Property;_NormalInBrumeGrunge_Contrast;NormalInBrumeGrunge_Contrast;78;0;Create;True;0;0;False;0;False;2.4;-6;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1191;2300.881,-1551.693;Inherit;False;Property;_NormalDrippingNoise_Tiling;NormalDrippingNoise_Tiling;71;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;1615;-4366.253,-920.1621;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.Vector2Node;1121;1873.395,-2694.396;Inherit;False;Property;_ShadowInBrumeGrunge_Tiling;ShadowInBrumeGrunge_Tiling;74;0;Create;True;0;0;False;0;False;1,1;0.5,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;1513;2016.603,-4583.454;Inherit;True;Property;_TextureSample17;Texture Sample 17;59;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;1503;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;523;-4415.28,-643.7766;Inherit;False;Property;_Roughness_Multiplier;Roughness_Multiplier;40;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1469;-6877.931,2847.791;Inherit;False;Property;_TerrainBlending;TerrainBlending?;12;0;Create;True;0;0;False;1;Header(TerrainBlending);False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1294;-5315.096,377.1138;Inherit;False;Property;_SSS_Scale;SSS_Scale;53;0;Create;True;0;0;False;0;False;0.46;0.46;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;1195;1567.446,-2788.528;Inherit;True;Property;_InBrumeGrunge_Texture2;ShadowInBrumeGrunge_Texture;73;0;Create;False;0;0;False;0;False;88d75bbfdb8a26849988713b4599646a;88d75bbfdb8a26849988713b4599646a;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.Vector2Node;1193;2294.179,-1464.238;Inherit;False;Property;_NormalDrippingNoise_Offset;NormalDrippingNoise_Offset;72;0;Create;True;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TFHCGrayscale;1105;2135.048,-2163.828;Inherit;True;2;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1221;3643.848,-3729.159;Inherit;False;Property;_ShadowDrippingNoise_Transition;ShadowDrippingNoise_Transition;64;0;Create;True;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1646;-6786.883,-6734.591;Inherit;False;Constant;_Float20;Float 20;1;0;Create;True;0;0;False;0;False;3;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;623;-4446.28,-384.7766;Inherit;False;Property;_SpecularColor;SpecularColor;39;0;Create;True;0;0;False;0;False;0.9433962,0.8590411,0.6274475,0;0.9433962,0.8590411,0.6274475,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1402;-4207.032,-146.7071;Inherit;False;Property;_Specular;Specular?;35;0;Create;True;0;0;False;1;Header(Specular);False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1300;-4878.509,348.4243;Inherit;False;Property;_SSS_Power;SSS_Power;54;0;Create;True;0;0;False;0;False;0.25;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1117;2565.258,-2685.252;Inherit;False;Property;_ShadowInBrumeGrunge_Contrast;ShadowInBrumeGrunge_Contrast;75;0;Create;True;0;0;False;0;False;-3.38;-60;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1520;2228.931,-4193.981;Inherit;True;Property;_TextureSample24;Texture Sample 24;59;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;1503;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;1643;-6525.128,-6901.483;Inherit;False;Flipbook;-1;;14;53c2488c220f6564ca6c90721ee16673;2,71,0,68,0;8;51;SAMPLER2D;0.0;False;13;FLOAT2;0,0;False;4;FLOAT;3;False;5;FLOAT;3;False;24;FLOAT;0;False;2;FLOAT;0;False;55;FLOAT;0;False;70;FLOAT;0;False;5;COLOR;53;FLOAT2;0;FLOAT;47;FLOAT;48;FLOAT;62
...
Node;AmplifyShaderEditor.RangedFloatNode;1308;-4085.18,-5703.892;Inherit;False;Property;_Wave_Speed;Wave_Speed;88;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1519;2845.798,-1537.024;Inherit;True;Property;_TextureSample25;Texture Sample 25;59;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;1503;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;1451;-6213.67,-6916.357;Inherit;True;Property;_TextureSample9;Texture Sample 9;98;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;1665;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1591;-5909.939,2922.918;Inherit;False;Property;_TopTex;TopTex?;41;0;Create;True;0;0;False;1;Header(Top Texture);False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;1310;-4103.792,-5448.661;Inherit;False;Property;_WindWave_Min_Speed;WindWave_Min_Speed;87;0;Create;True;0;0;False;0;False;0.05,0;0.05,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.ColorNode;1272;-4317.865,29.92182;Inherit;False;Property;_SSS_Color;SSS_Color;52;0;Create;True;0;0;False;0;False;1,0,0,0;1,0.007843138,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;1311;-4005.315,-5936.475;Inherit;False;Property;_WindWave_Speed;WindWave_Speed;86;0;Create;True;0;0;False;0;False;0.1,0;0.1,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;1419;2983.556,-4345.375;Inherit;False;Property;_InkSplatter;InkSplatter?;62;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1369;-5362.555,2704.322;Inherit;False;877;Shadow;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;1456;-5866.479,-6917.597;Inherit;False;Object_RimLightMask_Texture;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1392;-2074.881,-4508.435;Inherit;False;Property;_CustomRimLight_Opacity;CustomRimLight_Opacity;57;0;Create;True;0;0;False;0;False;1;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1652;-6791.051,-6421.917;Inherit;False;Constant;_Float21;Float 21;1;0;Create;True;0;0;False;0;False;4;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1050;4773.772,-4389.17;Inherit;False;Property;_InBrumeBackColor;InBrumeBackColor;61;0;Create;True;0;0;False;0;False;1,1,1,0;0.8962264,0.8890581,0.883544,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;1314;-3480.655,-5557.14;Inherit;False;Property;_Wind_Direction;Wind_Direction;83;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1391;-1901.88,-4390.435;Inherit;False;Property;_CustomRimLight_Color;CustomRimLight_Color;56;0;Create;True;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;1649;-6529.296,-6588.809;Inherit;False;Flipbook;-1;;15;53c2488c220f6564ca6c90721ee16673;2,71,0,68,0;8;51;SAMPLER2D;0.0;False;13;FLOAT2;0,0;False;4;FLOAT;3;False;5;FLOAT;3;False;24;FLOAT;0;False;2;FLOAT;0;False;55;FLOAT;0;False;70;FLOAT;0;False;5;COLOR;53;FLOAT2;0;FLOAT;47;FLOAT;48;FLOAT;62
...
Node;AmplifyShaderEditor.RangedFloatNode;1316;-3404.272,-5841.589;Inherit;False;Property;_Wind_Texture_Tiling;Wind_Texture_Tiling;82;0;Create;True;0;0;False;0;False;0.5;-0.08;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;989;4925.598,-3769.911;Inherit;False;Property;_ColorShadow;ColorShadow;60;0;Create;True;0;0;False;0;False;0.5283019,0.5283019,0.5283019,0;0.1509426,0.1509426,0.1509426,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1526;-599.9465,-5143.513;Inherit;False;Property;_DepthFade_Dither_Tiling;DepthFade_Dither_Tiling;92;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1321;-2823.918,-5639.736;Inherit;False;Property;_Wind_Density;Wind_Density;84;0;Create;True;0;0;False;0;False;0.2;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;1531;-463.7592,-5522.286;Inherit;True;Property;_DepthFade_Dither_Texture;DepthFade_Dither_Texture;91;0;Create;True;0;0;False;0;False;None;5249c43f26c99bf448754900521f6d27;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;1399;-4074.883,2915.979;Inherit;False;Property;_SSS;SSS?;50;0;Create;True;0;0;False;1;Header(SubSurface Scattering);False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;1320;-3121.824,-6050.601;Inherit;True;Property;_Wind_Noise_Texture;Wind_Noise_Texture;81;0;Create;True;0;0;False;0;False;1cb5d7a8b79999d4b8356e740bbf6667;1cb5d7a8b79999d4b8356e740bbf6667;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;1618;-6779.026,-7686.433;Inherit;False;Constant;_TextureIndex;TextureIndex;1;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1543;-144.1949,-5030.007;Inherit;False;Property;_DepthFade_Texture;DepthFade_Texture?;90;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1475;-5891.232,-6599.046;Inherit;False;Object_CustomOpacityMask_Texture;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1621;-6517.271,-7853.324;Inherit;False;Flipbook;-1;;16;53c2488c220f6564ca6c90721ee16673;2,71,0,68,0;8;51;SAMPLER2D;0.0;False;13;FLOAT2;0,0;False;4;FLOAT;3;False;5;FLOAT;3;False;24;FLOAT;0;False;2;FLOAT;0;False;55;FLOAT;0;False;70;FLOAT;0;False;5;COLOR;53;FLOAT2;0;FLOAT;47;FLOAT;48;FLOAT;62
Node;AmplifyShaderEditor.FunctionNode;1529;-178.7595,-5251.286;Inherit;False;Procedural Sample;-1;;17;f5379ff72769e2b4495e5ce2f004d8d4;2,157,0,315,0;7;82;SAMPLER2D;0;False;158;SAMPLER2DARRAY;0;False;183;FLOAT;0;False;5;FLOAT2;0,0;False;80;FLOAT3;0,0,0;False;104;FLOAT2;1,0;False;74;SAMPLERSTATE;0;False;5;COLOR;0;FLOAT;32;FLOAT;33;FLOAT;34;FLOAT;35
...
Node;AmplifyShaderEditor.SamplerNode;1665;-6235.556,-7858.533;Inherit;True;Property;_ObjectTextureAtlas;Object Texture Atlas;98;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1528;270.5949,-5163.497;Inherit;False;Property;_DepthFade_DitherMultiply;DepthFade_DitherMultiply;93;0;Create;True;0;0;False;0;False;1;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1400;-3465.153,2909.908;Inherit;False;Property;_CustomRimLight;CustomRimLight?;55;0;Create;True;0;0;False;1;Header(Custom Rim Light);False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1324;-2212.674,-5784.213;Inherit;False;Property;_Wind_Strength;Wind_Strength;85;0;Create;True;0;0;False;0;False;2;0.004;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;841;-3311.316,2275.755;Inherit;False;Property;_OutBrumeColorCorrection;OutBrumeColorCorrection;58;0;Create;True;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;1546;547.3438,-5117.007;Inherit;False;Property;_DepthFade_ClampMin;DepthFade_ClampMin;96;0;Create;True;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1457;-5913.438,-7762.385;Inherit;False;Object_Opacity_Texture;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1256;6340.335,-3425.694;Inherit;False;Property;_InBrumeColorCorrection;InBrumeColorCorrection;79;0;Create;True;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;1533;265.515,-5359.033;Inherit;False;Property;_DepthFade_Distance;DepthFade_Distance;95;0;Create;True;0;0;False;0;False;10.5;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1532;272.5149,-5441.033;Inherit;False;Property;_DepthFade_Falloff;DepthFade_Falloff;94;0;Create;True;0;0;False;0;False;3;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1535;547.0799,-5032.515;Inherit;False;Property;_DepthFade_ClampMax;DepthFade_ClampMax;97;0;Create;True;0;0;False;0;False;0.8;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1538;809.9427,-5717.329;Inherit;False;Property;_DepthFade;DepthFade?;89;0;Create;True;0;0;False;1;Header(Depth Fade);False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;1522;-6907.222,-6099.964;Inherit;False;2298.802;1114.077;TexturesArrays;2;1479;1480;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1408;2369.948,-5184.637;Inherit;False;Property;_WindVertexDisplacement;WindVertexDisplacement?;80;0;Create;True;0;0;False;1;Header(Wind);False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;1691;-4093.254,-8051.004;Inherit;False;661.7568;731.9858;InBrume Texture Atlas;10;1684;1682;1677;1680;1681;1686;1685;1678;1679;1683;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;1690;-5519.594,-8043.646;Inherit;False;761.6123;731.9863;Noise and Grunge OutBrume Texture Atlas;10;1667;1666;1669;1670;1672;1675;1676;1668;1687;1688;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;1453;-5913.764,-7859.36;Inherit;False;Object_Albedo_Texture;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;1605;-650.0344,-3801.251;Inherit;True;NormalCreate;0;;18;e12f7ae19d416b942820e3932b56220f;0;4;1;SAMPLER2D;;False;2;FLOAT2;0,0;False;3;FLOAT;0.5;False;4;FLOAT;2;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SamplerNode;1482;-5708.095,-5993.832;Inherit;True;Property;_NoiseandGrungeOutBrumeTextureArray;Noise and Grunge OutBrume Texture Array;19;0;Create;True;0;0;False;0;False;-1;8fdb86c7e9893674ea4c46a3398744c6;8fdb86c7e9893674ea4c46a3398744c6;True;0;False;white;Auto;False;Object;-1;Auto;Texture2DArray;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;1679;-4017.907,-7853.972;Inherit;False;1662;InBrumeTextureAtlas_Rows;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1684;-4023.254,-7513.098;Inherit;False;1662;InBrumeTextureAtlas_Rows;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1683;-4043.254,-7585.098;Inherit;False;1661;InBrumeTextureAtlas_Columns;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1666;-5049.981,-7935.425;Inherit;False;Flipbook;-1;;20;53c2488c220f6564ca6c90721ee16673;2,71,0,68,0;8;51;SAMPLER2D;0.0;False;13;FLOAT2;0,0;False;4;FLOAT;3;False;5;FLOAT;3;False;24;FLOAT;0;False;2;FLOAT;0;False;55;FLOAT;0;False;70;FLOAT;0;False;5;COLOR;53;FLOAT2;0;FLOAT;47;FLOAT;48;FLOAT;62
...
Node;AmplifyShaderEditor.FunctionNode;1672;-5055.329,-7594.551;Inherit;False;Flipbook;-1;;21;53c2488c220f6564ca6c90721ee16673;2,71,0,68,0;8;51;SAMPLER2D;0.0;False;13;FLOAT2;0,0;False;4;FLOAT;3;False;5;FLOAT;3;False;24;FLOAT;0;False;2;FLOAT;0;False;55;FLOAT;0;False;70;FLOAT;0;False;5;COLOR;53;FLOAT2;0;FLOAT;47;FLOAT;48;FLOAT;62
...
Node;AmplifyShaderEditor.FunctionNode;1682;-3728.844,-7601.91;Inherit;False;Flipbook;-1;;19;53c2488c220f6564ca6c90721ee16673;2,71,0,68,0;8;51;SAMPLER2D;0.0;False;13;FLOAT2;0,0;False;4;FLOAT;3;False;5;FLOAT;3;False;24;FLOAT;0;False;2;FLOAT;0;False;55;FLOAT;0;False;70;FLOAT;0;False;5;COLOR;53;FLOAT2;0;FLOAT;47;FLOAT;48;FLOAT;62
Node;AmplifyShaderEditor.FunctionNode;1677;-3723.497,-7942.784;Inherit;False;Flipbook;-1;;22;53c2488c220f6564ca6c90721ee16673;2,71,0,68,0;8;51;SAMPLER2D;0.0;False;13;FLOAT2;0,0;False;4;FLOAT;3;False;5;FLOAT;3;False;24;FLOAT;0;False;2;FLOAT;0;False;55;FLOAT;0;False;70;FLOAT;0;False;5;COLOR;53;FLOAT2;0;FLOAT;47;FLOAT;48;FLOAT;62
Node;AmplifyShaderEditor.RangedFloatNode;1680;-3985.252,-7775.892;Inherit;False;Constant;_Float33;Float 33;1;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1681;-3988.637,-8001.004;Inherit;False;1629;TextureCoordinates;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;1686;-3993.984,-7660.131;Inherit;False;1629;TextureCoordinates;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;1685;-3990.599,-7435.018;Inherit;False;Constant;_Float34;Float 34;1;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1678;-4037.907,-7925.972;Inherit;False;1661;InBrumeTextureAtlas_Columns;1;0;OBJECT;;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=25C23A63D89A47A385D85D728E2217843E7E8991