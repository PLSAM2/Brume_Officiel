	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				float2 texCoord322 = inputMesh.ase_texcoord.xy * temp_cast_0 + float2( 0,0 );
				...
				float2 texCoord340 = inputMesh.ase_texcoord.xy * temp_cast_2 + temp_cast_3;
				...
				float2 uv_OpacityMask_Texture = inputMesh.ase_texcoord.xy * _OpacityMask_Texture_ST.xy + _OpacityMask_Texture_ST.zw;
				...
				float3 staticSwitch267 = ( lerpResult14_g2.r * inputMesh.normalOS );
				#else
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 temp_cast_0 = (_BrumeTexture_Tiling).xx;
				float2 texCoord322 = packedInput.ase_texcoord1.xy * temp_cast_0 + float2( 0,0 );
				float mulTime476 = _TimeParameters.x * _BrumeAnimation_RotatorTime;
				float temp_output_508_0 = ( ( ( _TimeParameters.y * _BrumeAnimation_WaveFrequency ) + mulTime476 ) * _BrumeAnimation_WaveStrength );
				float2 temp_cast_1 = (( _BrumeTexture_Tiling * 0.5 )).xx;
				float cos473 = cos( temp_output_508_0 );
				...
				float dotResult177 = dot( worldNormal176 , -_DirectionalLightDatas[0].forward );
				float normal_LightDir180 = ( dotResult177 * 1 );
				...
				float screenDepth568 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				...
				float2 uv_OpacityMask_Texture = packedInput.ase_texcoord1.xy * _OpacityMask_Texture_ST.xy + _OpacityMask_Texture_ST.zw;
				...
				surfaceDescription.Color = BrumeColor315.rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = BrumeOpacity420;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 temp_cast_0 = (_BrumeTexture_Tiling).xx;
				float2 texCoord322 = packedInput.ase_texcoord.xy * temp_cast_0 + float2( 0,0 );
				float mulTime476 = _TimeParameters.x * _BrumeAnimation_RotatorTime;
				float temp_output_508_0 = ( ( ( _TimeParameters.y * _BrumeAnimation_WaveFrequency ) + mulTime476 ) * _BrumeAnimation_WaveStrength );
				float2 temp_cast_1 = (( _BrumeTexture_Tiling * 0.5 )).xx;
				float cos473 = cos( temp_output_508_0 );
				...
				float clampResult573 = clamp( ( distanceDepth568 * _DepthFade_Power ) , 0.0 , 1.0 );
				float DepthFade574 = clampResult573;
				float2 uv_OpacityMask_Texture = packedInput.ase_texcoord.xy * _OpacityMask_Texture_ST.xy + _OpacityMask_Texture_ST.zw;
				float4 tex2DNode516 = tex2D( _OpacityMask_Texture, uv_OpacityMask_Texture );
				float smoothstepResult526 = smoothstep( _BrumeEdges_Smoothstep , ( _BrumeEdges_Smoothstep + ( ( _TimeParameters.z * 0.4 ) + 1.0 ) ) , BrumeTextureSample329.r);
				float clampResult522 = clamp( ( (tex2DNode516.r*_OpacityMask_Scale + _OpacityMask_Offset) - smoothstepResult526 ) , 0.0 , 1.0 );
				float lerpResult581 = lerp( 0.0 , ( DepthFade574 * clampResult522 ) , _BrumeApparition);
		...
		Pass
		{
					...
					)
			{
				...
				float clampResult573 = clamp( ( distanceDepth568 * _DepthFade_Power ) , 0.0 , 1.0 );
				float DepthFade574 = clampResult573;
				float2 uv_OpacityMask_Texture = packedInput.ase_texcoord4.xy * _OpacityMask_Texture_ST.xy + _OpacityMask_Texture_ST.zw;
				float4 tex2DNode516 = tex2D( _OpacityMask_Texture, uv_OpacityMask_Texture );
				float2 temp_cast_0 = (_BrumeTexture_Tiling).xx;
				float2 texCoord322 = packedInput.ase_texcoord4.xy * temp_cast_0 + float2( 0,0 );
				float mulTime476 = _TimeParameters.x * _BrumeAnimation_RotatorTime;
				float temp_output_508_0 = ( ( ( _TimeParameters.y * _BrumeAnimation_WaveFrequency ) + mulTime476 ) * _BrumeAnimation_WaveStrength );
				float2 temp_cast_1 = (( _BrumeTexture_Tiling * 0.5 )).xx;
				float cos473 = cos( temp_output_508_0 );
...
/*ASEBEGIN
Version=18707
0;0;1920;1019;583.5405;5016.65;1;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;562;752.6329,-4817.349;Inherit;False;662.7542;517.8867;BrumeFinal;5;561;559;292;324;598;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;604;1170.409,-4767.349;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;DistortionVectors;0;6;DistortionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;4;1;False;-1;1;False;-1;4;1;False;-1;1;False;-1;True;1;False;-1;1;False;-1;False;False;False;False;False;False;False;True;0;True;-26;False;False;False;False;True;True;0;True;-11;255;False;-1;255;True;-12;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;False;True;1;LightMode=DistortionVectors;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;599;1170.409,-4767.349;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;ShadowCaster;0;1;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-26;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=ShadowCaster;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;600;1170.409,-4767.349;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;META;0;2;META;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;601;1170.409,-4767.349;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;SceneSelectionPass;0;3;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-26;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=SceneSelectionPass;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;602;1170.409,-4767.349;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;DepthForwardOnly;0;4;DepthForwardOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-26;True;False;False;False;False;0;False;-1;False;False;False;True;True;0;True;-7;255;False;-1;255;True;-8;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=DepthForwardOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;603;1170.409,-4767.349;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;Motion Vectors;0;5;Motion Vectors;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-26;False;False;False;False;True;True;0;True;-9;255;False;-1;255;True;-10;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=MotionVectors;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;598;1156.409,-4626.349;Float;False;True;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;16;BrumeVolume;7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;0;True;-20;0;True;-21;1;0;True;-22;0;True;-23;False;False;False;False;False;False;False;False;True;0;True;-26;False;False;False;False;True;True;0;True;-5;255;False;-1;255;True;-6;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;0;True;-24;True;0;True;-32;False;True;1;LightMode=ForwardOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;29;Surface Type;0;  Rendering Pass ;0;  Rendering Pass;1;  Blending Mode;0;  Receive Fog;1;  Distortion;0;    Distortion Mode;0;    Distortion Only;1;  Depth Write;1;  Cull Mode;0;  Depth Test;4;Double-Sided;0;Alpha Clipping;0;Motion Vectors;1;  Add Precomputed Velocity;0;Shadow Matte;0;Cast Shadows;1;DOTS Instancing;0;GPU Instancing;1;Tessellation;1;  Phong;0;  Strength;0.5,False,-1;  Type;1;  Tess;32,False,-1;  Min;0,False,-1;  Max;50,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;7;True;True;True;True;True;True;False;False;;False;0
...
WireConnection;598;0;292;0
WireConnection;598;2;324;0
WireConnection;598;6;559;0
ASEEND*/
//CHKSM=FF189D4F81B601D965B7A214D47DFC58AE3E4CF9